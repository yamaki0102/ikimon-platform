...
npm run smoke:platform-lane -- --base-url="${PUBLIC_BASE_URL}"
npm run smoke:platform-read-lane -- --base-url="${PUBLIC_BASE_URL}"
npm run smoke:platform-write-lane -- --base-url="${PUBLIC_BASE_URL}" --fixture-prefix="${FIXTURE_PREFIX}"
