...
curl -fsS "http://127.0.0.1:${PUBLIC_RUNTIME_PORT}/healthz" > "${TARGET_DIR}/v2-healthz.json"
curl -fsS "http://127.0.0.1:${PUBLIC_RUNTIME_PORT}/readyz" > "${TARGET_DIR}/v2-readyz.json"
curl -fsS "http://127.0.0.1:${PUBLIC_RUNTIME_PORT}/ops/readiness" > "${TARGET_DIR}/v2-ops-readiness.json"
