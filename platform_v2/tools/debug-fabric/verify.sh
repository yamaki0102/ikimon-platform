...
cd "$SCRIPT_DIR"
for file in run.mjs analyze-control-plane.mjs plan-execution.mjs lib/*.mjs tests/*.mjs local-runner/*.mjs local-runner/lib/*.mjs local-runner/tests/*.mjs; do node --check "$file"; done
