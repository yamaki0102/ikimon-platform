...
const ja: ObservationFirstRecordDetailCopy = {
  ...
  publicationReturnTitle: "公開と確認", publicationReview: "確認結果", publicationReviewNotReviewed: "未確認", publicationReviewApproved: "確認済み・承認", publicationReviewChangesRequested: "修正依頼", publicationReviewHeld: "保留", publicationReviewRejected: "却下", publicationReviewWithdrawn: "撤回",
  publicationEligibility: "公開状況", publicationNotReady: "未確認", publicationEligible: "公開可能（未公開）", publicationPublished: "公開確認済み", publicationExcluded: "公開対象外", publicationDestinations: "掲載先", publicationConfigured: "掲載先として設定済み（未公開）", publicationReadBack: "公開確認済み", publicationProductionReadonly: "公開フィード", publicationExclusion: "除外理由", publicationExclusionRecordNotPublic: "記録が公開範囲ではありません", publicationExclusionReviewNotApproved: "確認の承認がありません", publicationExclusionDestinationNotConfigured: "未取得", publicationExclusionConsentRequired: "この掲載先への同意がありません", publicationExclusionMinorUnknown: "未成年者区分を確認できません", publicationExclusionGuardianUnknown: "保護者権限を確認できません", publicationExclusionGuardianWithdrawn: "保護者同意が撤回されています", publicationExclusionWithdrawn: "記録または公開同意が撤回されています", publicationExclusionDefault: "必要な公開条件を満たしていません"
};
