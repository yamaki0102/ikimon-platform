...
export function renderObservationFirstRecordDetailHtml(
  ...
  const canonicalUrl = presentation.canonicalUrl ?? `https://zukan.earth/${lang}/observations/${encodeURIComponent(detail.recordId)}`;
