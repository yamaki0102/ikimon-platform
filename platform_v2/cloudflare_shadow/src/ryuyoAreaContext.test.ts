...
import { classifyRyuyoPoint, distanceToRyuyoBoundaryMeters, expandBboxByMeters, RYUYO_FIELD_ID, RYUYO_NEARBY_MAX_DISTANCE_METERS, type RyuyoGeometry } from "./ryuyoAreaContext";

const geometry: RyuyoGeometry = {
  type: "Polygon",
...
test("candidate query bbox expands before read-time classification", () => {
  const expanded = expandBboxByMeters({ minLat: 34.6684471, maxLat: 34.6712001, minLng: 137.8391405, maxLng: 137.8407421 });
