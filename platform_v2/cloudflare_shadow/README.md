...
5. Production import and rollback still need a final route-change dress rehearsal that includes full app compatibility, write-drain or reverse-delta on the integrated staging route, production-imported data, R2 inventory recheck, and rollback smoke.
