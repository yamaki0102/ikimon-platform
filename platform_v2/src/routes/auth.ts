...
function authPageCopy(lang: SiteLang): AuthPageCopy {
  const localized: Record<SiteLang, AuthPageCopy> = {
    ja: {
      ...
      recordNoteLead: "記録、写真アップロード、同定参加は ZUKAN のログイン状態で扱います。",
    ...
    en: {
      ...
      recordNoteLead: "Records, photo uploads, and identification participation use your ZUKAN login state.",
    ...
    es: {
      ...
      recordNoteLead: "Registros, subidas de fotos e identificaciones usan tu sesion de ZUKAN.",
    ...
    "pt-BR": {
      ...
      recordNoteLead: "Registros, uploads de fotos e identificacoes usam seu login do ZUKAN.",
