...
function landingCopy(lang: SiteLang) {
  const copy = {
    ja: {
      ...
      toolSectionEyebrow: "補助機能",
      toolSectionTitle: "ノートを育てる 2 つの入口",
      toolSectionLead: "フィールドノートが主役。AIレンズとフィールドスキャンは、そこに書き足しやすくするための補助機能です。",
      tools: {
        lens: {
          eyebrow: "AIレンズ",
          title: "撮った瞬間、AI が候補を返す",
          body: "名前を知らなくても、ノートの最初の一行を書き始められる。撮影から即、同定候補が並びます。",
          cta: "AIレンズを見る",
          badge: "beta",
        },
        scan: {
          eyebrow: "フィールドスキャン",
          title: "歩きながら近辺の種の気配を拾う",
          body: "次にノートへ書き足す場所を、おすすめ調査エリアとしてマップが教えてくれます。",
          cta: "フィールドスキャンを見る",
          badge: "v0.10",
        },
      },
      mapSectionEyebrow: "探索マップ",
      mapSectionTitle: "ノートに残された場所を、地図で見返す",
      mapSectionLead: "あなたと周りの観察が、どの場所に積み上がっているかを地図で確認できます。",
      mapCta: "マップで全体を見る",
      mapEmpty: "まだ地図に載せる観察がありません",
      bizEyebrow: "法人向け",
      bizTitle: "🏢 組織で使いたい方へ",
      bizBody: "企業や自治体で、場所の記録をあとで見返しやすい形に整えられます。",
      bizCta: "法人向け",
      footerNote: "ikimon.life v2 — 歩いて、見つけて、ノートに残す。",
    },
    en: {
      ...
      heroLead: "Stack your walks and nearby finds into one field notebook. The more you re-read it, the more the same path changes.",
      ...
      toolSectionEyebrow: "Supporting tools",
    ...
    es: {
      ...
      heroLead: "Apila tus paseos y hallazgos cercanos en un solo cuaderno de campo. Cuanto más lo relees, más cambia el mismo camino.",
      ...
      toolSectionEyebrow: "Herramientas de apoyo",
    ...
    "pt-BR": {
      ...
      heroLead: "Empilhe suas caminhadas e descobertas próximas em um único caderno de campo. Quanto mais você relê, mais o mesmo caminho muda.",
      ...
      toolSectionEyebrow: "Ferramentas de apoio",
