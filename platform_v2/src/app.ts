...
function fieldLoopSectionCopy(lang: SiteLang) {
  const copy = {
    ja: {
      ...
      title: "衛星で狙い、足で確かめ、ノートに返す。",
      lead: "1 本のループが、同じ道を新しくする。観測の空白と、不在の証拠は、きちんと分ける。",
      ...
      boundaryTitle: "言葉の約束",
      steps: [
        { title: "1. 衛星で狙う", body: "林縁・水際・湿地・遷移帯。怪しい場所を先に炙り出す。" },
        { title: "2. 仮説を3つに絞る", body: "今日確かめる microhabitat、撮る 1 枚、残す文脈。" },
        { title: "3. AI は断定しない", body: "見えた特徴と、足りない証拠と、次に欲しい 1 枚を返す。" },
        { title: "4. 差分が、資産になる", body: "季節の変化が積み上がって、また来る理由が育つ。" },
      ],
      principles: [
        "答えより、目を育てる。",
        "種名より、文脈を厚く。",
    ...
    en: {
      eyebrow: "satellite → field → loop",
      title: "Target from satellite. Check on foot. Return to the notebook.",
      lead: "One loop, and the same path keeps changing. Blank coverage and evidence of absence stay clearly apart.",
      ...
      steps: [
        { title: "1. Target from satellite", body: "Edges, water, wetlands, succession zones — flagged before you leave home." },
        { title: "2. Narrow to three", body: "The microhabitat to verify. The shot to take. The context to save." },
        { title: "3. AI never overclaims", body: "Visible traits. Missing evidence. The next shot worth taking." },
        { title: "4. Deltas compound", body: "Season by season. And a reason to come back keeps growing." },
      ],
      principles: [
        "Train the eye, not the answer.",
        "Thicken context before certainty.",
        "Never blur blank with absent.",
    ...
    es: {
      eyebrow: "satellite → field → loop",
      title: "Apunta desde el satélite. Comprueba a pie. Devuélvelo al cuaderno.",
      lead: "Un bucle — y el mismo camino se renueva. Vacío y ausencia se mantienen claramente separados.",
      ...
      steps: [
        { title: "1. Apuntar desde el satélite", body: "Bordes, agua, humedales, sucesión — marcados antes de salir." },
        { title: "2. Reducir a tres", body: "Microhábitat a verificar. Foto a tomar. Contexto a guardar." },
        { title: "3. La IA no finge", body: "Rasgos visibles. Evidencia faltante. La próxima foto útil." },
        { title: "4. El delta se acumula", body: "Estación a estación. Y crece un motivo para volver." },
      ],
      principles: [
        "Entrenar la mirada, no la respuesta.",
        "Más contexto antes que certeza.",
        "No confundir vacío con ausencia.",
        "La incertidumbre también es dato.",
      ],
      boundaries: [
    ...
    "pt-BR": {
      eyebrow: "satellite → field → loop",
      title: "Mire pelo satélite. Confira a pé. Devolva ao caderno.",
      lead: "Um loop — e o mesmo caminho se renova. Vazio e ausência ficam claramente separados.",
      ...
      steps: [
        { title: "1. Mirar pelo satélite", body: "Bordas, água, áreas úmidas, sucessão — marcados antes de sair." },
        { title: "2. Reduzir a três", body: "Microhabitat a verificar. Foto a tirar. Contexto a salvar." },
        { title: "3. A IA não finge", body: "Traços visíveis. Evidência faltante. A próxima foto que vale." },
        { title: "4. O delta se acumula", body: "Estação após estação. E cresce um motivo para voltar." },
      ],
      principles: [
        "Treinar o olhar, não a resposta.",
        "Mais contexto antes da certeza.",
        "Não confundir vazio com ausência.",
        "Incerteza também é dado.",
      ],
      boundaries: [
