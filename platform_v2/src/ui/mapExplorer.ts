...
export const MAP_EXPLORER_COPY: Record<SiteLang, MapExplorerCopy> = {
  ja: {
    ...
    personalPulseBody: "投稿したあとは、マイページや自分の記録一覧で確認できます。地図には最近の記録も重なっていきます。",
...
(function () {
  ...
  var COPY = ${JSON.stringify({
    ...
    campaign_note_repeatable: props.lang === "ja" ? "比較できる場所の記録をもう一段増やす" : props.lang === "es" ? "Hacer más densa una zona repetible" : props.lang === "pt-BR" ? "Tornar mais espessa uma zona repetível" : "Thicken one repeatable area",
    ...
    priority_steady_revisit: props.lang === "ja" ? "再訪で記録を増やす" : props.lang === "es" ? "Engrosar con revisitas" : props.lang === "pt-BR" ? "Espessar com revisitas" : "Thicken by revisiting",
    ...
    impactPanelTitleMine: props.lang === "ja" ? "この記録で見えてきたこと" : props.lang === "es" ? "Cómo ayudan tus registros" : props.lang === "pt-BR" ? "Como seus registros ajudam" : "How your records help",
    ...
    impactCommunityStory: props.lang === "ja" ? "最近、見える手がかりが増えた場所" : props.lang === "es" ? "Lugares que se hicieron más claros hace poco" : props.lang === "pt-BR" ? "Lugares que ficaram mais claros recentemente" : "Places that became clearer recently",
    ...
    areaCompleteSeasonLead: props.lang === "ja" ? "四季の入口があります。次は同じ季節の再訪で比較材料を増やせます。" : props.lang === "es" ? "Ya hay entrada para las cuatro temporadas. Ahora conviene revisitar." : props.lang === "pt-BR" ? "Já há entrada para as quatro estações. Agora vale revisitar." : "All seasons have an entry. Revisit to add depth.",
    ...
    areaPositiveThanks: props.lang === "ja" ? "あなたの記録から" : props.lang === "es" ? "Desde tus registros" : props.lang === "pt-BR" ? "A partir dos seus registros" : "From your records",
    areaPositiveThanksGuest: props.lang === "ja" ? "みんなの記録から" : props.lang === "es" ? "Desde los registros de todos" : props.lang === "pt-BR" ? "A partir dos registros de todos" : "From everyone's records",
    ...
    areaPositiveMineRecords: props.lang === "ja" ? "自分の記録を確認する" : props.lang === "es" ? "Revisar mis registros" : props.lang === "pt-BR" ? "Rever meus registros" : "Review my records",
