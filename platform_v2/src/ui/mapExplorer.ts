...
export const MAP_EXPLORER_COPY: Record<SiteLang, MapExplorerCopy> = {
  ja: {
    ...
    legendLabel: "凡例",
    coverageLegendLow: "記録前",
    coverageLegendHigh: "記録あり",
    ...
    layerHintFrontier: "ズームすると記録候補の範囲が見えます。",
    ...
    empty: "この範囲には表示できる記録がまだありません。近くの候補エリアを見るか、範囲を広げて確認できます。",
    emptyTitle: "この範囲の記録はまだありません",
    emptyLead: "近くの公開エリアを見つけるか、範囲を広げて確認できます。見つけたものがあれば、その場で記録できます。",
    ...
    areaNextStepRecordTitle: "安全に、この場所を記録する",
    ...
    areaNextStepFirstRecordLine: "公開範囲で見つけたものを記録できます。",
  ...
  en: {
    ...
    layerHintFrontier: "Zoom in to see suggested recording areas.",
    ...
    empty: "No visible records are available in this area yet. Check nearby public areas or widen the map.",
    emptyTitle: "No records here yet",
    emptyLead: "Use nearby public areas, widen the map, or record what you find.",
    emptyActionAreas: "Nearby areas",
    emptyActionWiden: "Widen map",
    emptyActionRecord: "Record",
    ...
    recordingGapLabel: "Records in this area",
    ...
    areaNextStepRecordTitle: "Record this place safely",
    ...
    areaNextStepFirstRecordLine: "Record what you find from public scope.",
  ...
  es: {
    ...
    tabCoverage: "Zonas para registrar",
    ...
    layerHintFrontier: "Acércate para ver zonas sugeridas de registro.",
    ...
    empty: "Aun no hay registros visibles en esta zona. Revisa areas publicas cercanas o amplia el mapa.",
    emptyTitle: "Aun no hay registros aqui",
    emptyLead: "Usa areas publicas cercanas, amplia el mapa o registra lo que encuentres.",
    emptyActionAreas: "Areas cercanas",
    emptyActionWiden: "Ampliar mapa",
    emptyActionRecord: "Registrar",
    ...
    recordingGapLabel: "Registros de esta zona",
    ...
    areaNextStepRecordTitle: "Registrar este lugar con seguridad",
    ...
    areaNextStepFirstRecordLine: "Registra lo que encuentres desde un alcance publico.",
  ...
  "pt-BR": {
    ...
    tabCoverage: "Areas para registrar",
    ...
    layerHintFrontier: "Aproxime o zoom para ver areas sugeridas de registro.",
    ...
    empty: "Ainda nao ha registros visiveis nesta area. Veja areas publicas proximas ou amplie o mapa.",
    emptyTitle: "Ainda nao ha registros aqui",
    emptyLead: "Use areas publicas proximas, amplie o mapa ou registre o que encontrar.",
    emptyActionAreas: "Areas proximas",
    emptyActionWiden: "Ampliar mapa",
    emptyActionRecord: "Registrar",
    ...
    recordingGapLabel: "Registros desta area",
    ...
    areaNextStepRecordTitle: "Registrar este lugar com seguranca",
    ...
    areaNextStepFirstRecordLine: "Registre o que encontrar em escopo publico.",
...
function ambientPanelLabels(lang: SiteLang): {
  ...
  return {
    ...
    communityLabel: "みんなの記録がある場所",
    frontierLabel: "次に見に行きたい候補",
...
export function renderMapExplorer(props: MapExplorerProps): string {
  ...
  const sideSelectionEmptyLabel = lang === "ja"
    ? "エリアや記録の厚みを選ぶと、この地域の今の姿と、次に確かめる記録が見えます。記録は地域単位で集計しています。"
    : lang === "es"
...
(function () {
  ...
  var COPY = ${JSON.stringify({
    ...
    actorHint_casual: props.lang === "ja" ? "生活動線の近くにある候補を見る" : props.lang === "es" ? "Ver lugares pendientes cerca de la rutina" : props.lang === "pt-BR" ? "Ver lugares pendentes perto da rotina" : "Look for nearby everyday candidates",
    roleHintScan: props.lang === "ja" ? "気になる候補を見に行くなら周辺を散歩" : props.lang === "es" ? "Pasea alrededor para conocer huecos" : props.lang === "pt-BR" ? "Caminhe ao redor para conhecer vazios" : "Walk nearby to explore candidate spots",
    ...
    frontierBuildingLabel: props.lang === "ja" ? "記録前" : props.lang === "es" ? "por registrar" : props.lang === "pt-BR" ? "por registrar" : "not recorded",
    ...
    campaign_guide_building: props.lang === "ja" ? "記録前の場所を確かめる" : props.lang === "es" ? "Comprobar zonas por registrar" : props.lang === "pt-BR" ? "Verificar areas por registrar" : "Check an unrecorded area",
  ...
  function renderResultsLoadingState() {
    ...
    return '<section class="me-results-loading" aria-label="' + escapeHtml(COPY.loading) + '">' +
  ...
  function renderSchoolAlbumEntrypoints(field) {
    ...
    return ''
      ...
      +     '<span>学校周辺の記録</span>'
      +     '<strong>授業、通学路、季節比較に分けて公開範囲の記録を見る。</strong>'
      +   '</div>'
