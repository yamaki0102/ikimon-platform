...
export const MAP_EXPLORER_COPY: Record<SiteLang, MapExplorerCopy> = {
  ja: {
    ...
    siteBriefReasonsLabel: "気になる理由",
    siteBriefChecksLabel: "その場で見たいこと",
    siteBriefCapturesLabel: "持ち帰るなら",
    siteBriefWhyHereLabel: "ここが気になる理由",
    siteBriefWhyNowLabel: "今見ると面白い理由",
    siteBriefOneVisitLabel: "1 回の訪問で見えてくること",
    siteBriefNextHookLabel: "次にまた行きたくなる理由",
    siteBriefLoading: "この地点が気になる理由を整理しています…",
    siteBriefError: "この地点の理由をうまく読めませんでした。地図や周囲の様子も見ながら判断してください。",
    searchPlaceholder: "場所や生きものを探す（例: 静岡市 谷津山、モンシロチョウ）",
    searchAriaLabel: "場所または種を検索",
    searchNoResult: "見つかりませんでした。地名や種名を短くして試してください。",
    searchError: "検索できませんでした。少し待ってからもう一度試してください。",
...
function overlayPanelLabels(lang: SiteLang): {
  ...
  return { heading: "レイヤー", intro: "ベース地図の上に重ねて、地形や行政情報と観察記録を一緒に見ます。", opacityLabel: "濃度" };
}
...
function ambientPanelLabels(lang: SiteLang): {
  ...
  return {
    ...
    roles: [
      ...
      { value: "mixed", label: "重ねる", icon: "🧭" },
    ],
    selfLabel: "自分の見え方",
    communityLabel: "地域の見え方",
    frontierLabel: "観察の余白",
    roleCardLabel: "この場所で向いている見方",
  };
}
...
function actorPanelLabels(lang: SiteLang): {
  ...
  return {
    actorLabel: "見る主体",
    actors: [
      { value: "all", label: "全体", icon: "🧭" },
      { value: "local_steward", label: "同じ場所を見続ける人", icon: "🏡" },
      { value: "traveler", label: "旅先で見る人", icon: "🧳" },
      { value: "casual", label: "近場で少し見る人", icon: "🚶" },
    ],
  };
}
...
(function () {
  ...
  var COPY = ${JSON.stringify({
    ...
    loopHookTravelerFallback: props.lang === "ja" ? "今回の 1 回が、次にまた寄る理由になる" : props.lang === "es" ? "Convierte esta visita en motivo para volver" : props.lang === "pt-BR" ? "Transforme esta visita em motivo para voltar" : "Turn this one visit into a reason to return",
    loopHookLocalFallback: props.lang === "ja" ? "次にまた見たくなる理由を 1 つ残す" : props.lang === "es" ? "Deja una razón breve para volver" : props.lang === "pt-BR" ? "Deixe um motivo curto para voltar" : "Leave one short reason to return",
    loopHookLocalPrefix: props.lang === "ja" ? "次に気になるのは " : props.lang === "es" ? "Lo siguiente: " : props.lang === "pt-BR" ? "Próximo: " : "Next: ",
    ...
    actor_local_steward: props.lang === "ja" ? "同じ場所を見続ける人" : props.lang === "es" ? "Cuidador local" : props.lang === "pt-BR" ? "Guardião local" : "Local steward",
    actor_traveler: props.lang === "ja" ? "旅先で見る人" : props.lang === "es" ? "Viajero" : props.lang === "pt-BR" ? "Viajante" : "Traveler",
    actor_casual: props.lang === "ja" ? "近場で少し見る人" : props.lang === "es" ? "Casual" : props.lang === "pt-BR" ? "Casual" : "Casual",
    actorHint_all: props.lang === "ja" ? "地図全体で、まだ薄いところを見る" : props.lang === "es" ? "Mirar la frontera total" : props.lang === "pt-BR" ? "Ver a fronteira total" : "Look at the whole frontier",
    actorHint_local_steward: props.lang === "ja" ? "同じ場所を見直しながら、変化を追う前提で見る" : props.lang === "es" ? "Mirar para volver y cuidar" : props.lang === "pt-BR" ? "Olhar para voltar e cuidar" : "Look as someone who will return",
    actorHint_traveler: props.lang === "ja" ? "一度の訪問で拾いやすい手がかりを探す" : props.lang === "es" ? "Buscar huecos para una sola visita" : props.lang === "pt-BR" ? "Buscar vazios de visita única" : "Look for gaps to open in one visit",
    actorHint_casual: props.lang === "ja" ? "生活動線の近くで、少し足せる場所を見る" : props.lang === "es" ? "Ver huecos cercanos a la rutina" : props.lang === "pt-BR" ? "Ver lacunas perto da rotina" : "Look for nearby routine gaps",
    roleHintScan: props.lang === "ja" ? "まず広く気配を見る" : props.lang === "es" ? "Si quieres abrir huecos, usa Escaneo" : props.lang === "pt-BR" ? "Se quer abrir vazios, use Escaneamento" : "Use Scan to open blank areas",
    roleHintGuide: props.lang === "ja" ? "その場所らしさを確かめる" : props.lang === "es" ? "Usa Guía para subir la certeza" : props.lang === "pt-BR" ? "Use Guia para subir a certeza" : "Use Guide to raise certainty",
    roleHintNote: props.lang === "ja" ? "前回との違いを残す" : props.lang === "es" ? "Usa Nota para hacer comparables los registros" : props.lang === "pt-BR" ? "Use Nota para tornar comparável" : "Use Note to make it revisitable",
    roleHintMixed: props.lang === "ja" ? "いくつかの見方を重ねる" : props.lang === "es" ? "Hoy avanza poco a poco en modo mixto" : props.lang === "pt-BR" ? "Hoje avance em modo misto" : "Use Mixed for a quiet all-round step",
    axis_scan_pass: props.lang === "ja" ? "次の場所探しが薄い" : props.lang === "es" ? "Falta Escaneo" : props.lang === "pt-BR" ? "Falta Scan" : "Scan is thin",
    axis_guide_scene: props.lang === "ja" ? "その場での確認が薄い" : props.lang === "es" ? "Falta Guía" : props.lang === "pt-BR" ? "Falta Guia" : "Guide is thin",
    axis_revisit_note: props.lang === "ja" ? "見返し用の記録が薄い" : props.lang === "es" ? "Falta Nota" : props.lang === "pt-BR" ? "Falta Nota" : "Note is thin",
    ...
    winsLabel: props.lang === "ja" ? "見えてきた変化" : props.lang === "es" ? "Avances" : props.lang === "pt-BR" ? "Avanços" : "wins",
    ...
    communityProgressLabel: props.lang === "ja" ? "みんなで見えてきた変化" : props.lang === "es" ? "Progreso colectivo" : props.lang === "pt-BR" ? "Progresso coletivo" : "collective progress",
    ...
    frontierBuildingLabel: props.lang === "ja" ? "少し記録あり" : props.lang === "es" ? "en construcción" : props.lang === "pt-BR" ? "em construção" : "building",
    ...
    campaign_scan_blank: props.lang === "ja" ? "まだ薄い見え方をひとつ開く" : props.lang === "es" ? "Abrir una banda vacía" : props.lang === "pt-BR" ? "Abrir uma faixa vazia" : "Open one blank band",
    campaign_guide_building: props.lang === "ja" ? "少し見えている場所をもう少し確かめる" : props.lang === "es" ? "Subir la certeza de zonas en crecimiento" : props.lang === "pt-BR" ? "Aumentar a certeza das zonas em crescimento" : "Raise certainty in building areas",
    campaign_note_repeatable: props.lang === "ja" ? "比べられる場所の解像度を上げる" : props.lang === "es" ? "Hacer más densa una zona repetible" : props.lang === "pt-BR" ? "Tornar mais espessa uma zona repetível" : "Thicken one repeatable area",
    campaign_mixed_frontier: props.lang === "ja" ? "無理なく次の見え方を増やす" : props.lang === "es" ? "Empujar la frontera con calma" : props.lang === "pt-BR" ? "Avançar a fronteira com calma" : "Quietly move the frontier forward",
    priorityCueLabel: props.lang === "ja" ? "いま気になる点" : props.lang === "es" ? "prioridad" : props.lang === "pt-BR" ? "prioridade" : "priority",
    priority_steady_revisit: props.lang === "ja" ? "前回との違いが見えやすい" : props.lang === "es" ? "Engrosar con revisitas" : props.lang === "pt-BR" ? "Espessar com revisitas" : "Thicken by revisiting",
    priority_fresh_gap: props.lang === "ja" ? "まだ見えていないものがありそう" : props.lang === "es" ? "Abrir un hueco nuevo" : props.lang === "pt-BR" ? "Abrir um vazio novo" : "Open a fresh gap",
    priority_nearby_gap: props.lang === "ja" ? "少し寄るだけで見え方が増えそう" : props.lang === "es" ? "Cubrir huecos cercanos" : props.lang === "pt-BR" ? "Cobrir lacunas próximas" : "Fill a nearby thin band",
    remainingLabel: props.lang === "ja" ? "まだ薄いところ" : props.lang === "es" ? "fronteras restantes" : props.lang === "pt-BR" ? "fronteiras restantes" : "frontier left",
    ...
    selectHint: props.lang === "ja" ? "エリアか一覧を選ぶと、ここに写真と気になる理由が出る。" : props.lang === "es" ? "Elige un área o una fila para ver foto y siguiente acción." : props.lang === "pt-BR" ? "Escolha uma área ou item para ver foto e próxima ação." : "Pick an area or row to see the photo and next action.",
    placeHint: props.lang === "ja" ? "地図を押すと、その地点が気になる理由をここに出す。" : props.lang === "es" ? "Toca el mapa para ver la hipótesis del lugar y la siguiente acción." : props.lang === "pt-BR" ? "Toque no mapa para ver a hipótese do lugar e a próxima ação." : "Tap the map to see the place hypothesis and next action.",
    selectedCardLabel: props.lang === "ja" ? "詳細を見る" : props.lang === "es" ? "Ver detalle" : props.lang === "pt-BR" ? "Ver detalhes" : "Open detail",
    selectedFieldLabel: props.lang === "ja" ? "この場所で見てみたいこと" : props.lang === "es" ? "Qué mirar aquí" : props.lang === "pt-BR" ? "O que ver aqui" : "What to look for here",
    selectedRoleLead: props.lang === "ja" ? "向いている見方は" : props.lang === "es" ? "Siguiente" : props.lang === "pt-BR" ? "Próximo" : "Next",
    ...
    insightHeading: props.lang === "ja" ? "この範囲の見え方" : props.lang === "es" ? "Progreso tranquilo" : props.lang === "pt-BR" ? "Progresso calmo" : "Quiet progress",
    insightSubhead: props.lang === "ja" ? "この viewport で、どこが濃く、どこがまだ薄いかを見る。" : props.lang === "es" ? "Cómo de densa está esta ventana." : props.lang === "pt-BR" ? "Quanto esta janela já acumulou." : "How this viewport is stacking up.",
  })};
