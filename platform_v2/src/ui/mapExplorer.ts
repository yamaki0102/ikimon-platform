...
export const MAP_EXPLORER_COPY: Record<SiteLang, MapExplorerCopy> = {
  ja: {
    ...
    siteBriefLoading: "この地点で何を見ればよいか整理しています…",
    siteBriefError: "この地点の手がかりを出せませんでした。地図や周囲の様子を見ながら判断してください。",
...
function ambientPanelLabels(lang: SiteLang): {
  ...
  return {
    ...
    roles: [
      ...
      { value: "scan", label: "次の場所を探す", icon: "📡" },
      { value: "mixed", label: "組み合わせる", icon: "🧭" },
    ],
    selfLabel: "自分の前進",
    communityLabel: "地域の前進",
    frontierLabel: "次の手がかり",
...
(function () {
  ...
  var COPY = ${JSON.stringify({
    ...
    roleHintScan: props.lang === "ja" ? "次の場所を探すなら、この見方" : props.lang === "es" ? "Si quieres abrir huecos, usa Escaneo" : props.lang === "pt-BR" ? "Se quer abrir vazios, use Escaneamento" : "Use Scan to open blank areas",
    roleHintGuide: props.lang === "ja" ? "その場で確かめるなら、この見方" : props.lang === "es" ? "Usa Guía para subir la certeza" : props.lang === "pt-BR" ? "Use Guia para subir a certeza" : "Use Guide to raise certainty",
    roleHintNote: props.lang === "ja" ? "あとで比べやすく残すなら、この見方" : props.lang === "es" ? "Usa Nota para hacer comparables los registros" : props.lang === "pt-BR" ? "Use Nota para tornar comparável" : "Use Note to make it revisitable",
    roleHintMixed: props.lang === "ja" ? "今日は小さく全体を見る" : props.lang === "es" ? "Hoy avanza poco a poco en modo mixto" : props.lang === "pt-BR" ? "Hoje avance em modo misto" : "Use Mixed for a quiet all-round step",
    ...
    campaign_guide_building: props.lang === "ja" ? "少し記録がある場所の確かさを上げる" : props.lang === "es" ? "Subir la certeza de zonas en crecimiento" : props.lang === "pt-BR" ? "Aumentar a certeza das zonas em crescimento" : "Raise certainty in building areas",
    ...
    campaign_mixed_frontier: props.lang === "ja" ? "無理なく次の手がかりを増やす" : props.lang === "es" ? "Empujar la frontera con calma" : props.lang === "pt-BR" ? "Avançar a fronteira com calma" : "Quietly move the frontier forward",
    ...
    remainingLabel: props.lang === "ja" ? "残っている薄い場所" : props.lang === "es" ? "fronteras restantes" : props.lang === "pt-BR" ? "fronteiras restantes" : "frontier left",
