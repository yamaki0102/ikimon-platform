...
/* ZUKAN public Home: calm product entry, with existing records as proof. */
.home-state-view{gap:clamp(42px,5vw,72px);padding:clamp(34px,6vw,72px) 0 72px}.home-guest-hero{min-height:0;align-content:start}.home-guest-hero.has-visual{grid-template-columns:minmax(0,.9fr) minmax(0,1.1fr);gap:clamp(32px,5vw,72px);align-items:center}.home-guest-hero-copy{max-width:620px;gap:18px}.home-guest-hero-copy>.home-product-kicker{display:none}.home-guest-hero h1{max-width:620px;font-size:clamp(3.5rem,5vw,4.25rem);line-height:1.08;letter-spacing:-.045em;text-wrap:balance}.home-hero-phrase{display:inline;max-width:none}.home-guest-hero p{max-width:34rem}.home-hero-actions{gap:12px 24px}.home-primary-button{min-height:48px;padding:0 22px;border-radius:12px}.home-secondary-link{font-weight:800;text-underline-offset:5px}.home-invite-note{order:3;margin:-6px 0 0!important;color:var(--home-muted)!important;font-size:.78rem!important;font-weight:650}.home-guest-proof{min-height:400px;border-radius:18px;background:#f1f5f1}.home-guest-proof-caption{padding:42px 16px 14px}.home-guest-proof-caption .home-guest-proof-status{color:rgba(255,255,255,.9);font-size:.7rem}.home-guest-proof.is-empty{min-height:400px;display:grid;grid-template-columns:1fr;grid-template-rows:1fr auto;place-items:stretch;align-content:initial;gap:0;background:#f1f5f1}.home-guest-proof.is-empty .home-empty-proof-art{display:none}.home-empty-proof-flow{display:grid;grid-template-columns:auto minmax(0,1fr);gap:22px;align-items:center;padding:clamp(24px,4vw,48px);background:linear-gradient(135deg,#edf4ef,#f8faf7)}.home-empty-proof-symbol{width:64px;height:64px;display:grid;place-items:center;border:1px solid rgba(20,63,46,.14);border-radius:16px;background:#fff;box-shadow:0 12px 24px rgba(20,63,46,.08)}.home-empty-proof-symbol img{width:42px;height:42px}.home-empty-proof-flow ol{display:grid;gap:13px;margin:0;padding:0;list-style:none}.home-empty-proof-flow li{display:grid;grid-template-columns:30px minmax(0,1fr);gap:12px;align-items:baseline;color:var(--home-green-dark)}.home-empty-proof-flow li b{color:var(--home-leaf);font-size:.72rem;letter-spacing:.08em}.home-empty-proof-flow li span{font-size:clamp(1rem,2vw,1.18rem);font-weight:800}.home-empty-proof-copy{padding:18px 22px;background:#fff}.home-guest-proof.is-empty .home-empty-proof-copy p{padding:0;font-size:.85rem;line-height:1.65}
@media(max-width:959px){.home-guest-hero.has-visual{grid-template-columns:minmax(0,1fr) minmax(0,1fr);gap:28px}.home-guest-hero h1{font-size:clamp(2.8rem,6vw,3.5rem)}.home-guest-proof{min-height:340px}}
@media(max-width:767px){.home-state-view{gap:48px;padding:28px 0 56px}.home-guest-hero.has-visual{grid-template-columns:1fr;gap:28px}.home-guest-hero-copy{gap:16px}.home-guest-hero h1{max-width:100%;font-size:clamp(2.35rem,10vw,3.15rem);line-height:1.12;letter-spacing:-.04em}.home-guest-hero p{font-size:.98rem;line-height:1.7}.home-guest-proof{min-height:0}.home-guest-proof.is-empty{min-height:0}.home-empty-proof-flow{gap:16px;padding:24px 20px}.home-empty-proof-symbol{width:52px;height:52px;border-radius:13px}.home-empty-proof-symbol img{width:34px;height:34px}.home-empty-proof-flow ol{gap:10px}.home-empty-proof-flow li{grid-template-columns:26px minmax(0,1fr);gap:8px}.home-empty-proof-flow li span{font-size:1rem}.home-empty-proof-copy{padding:16px 18px}.home-hero-actions{align-items:stretch}.home-primary-button{min-width:88px}.home-secondary-link{min-height:48px}}
@media(max-width:420px){.home-guest-hero h1{font-size:clamp(2.2rem,10.4vw,2.8rem)}.home-empty-proof-flow{grid-template-columns:1fr;gap:18px}.home-empty-proof-symbol{width:48px;height:48px}.home-empty-proof-flow ol{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px}.home-empty-proof-flow li{display:block}.home-empty-proof-flow li b,.home-empty-proof-flow li span{display:block}.home-empty-proof-flow li b{margin-bottom:5px}.home-empty-proof-flow li span{font-size:.86rem;line-height:1.35}}
