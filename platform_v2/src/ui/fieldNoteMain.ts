...
const mainCopy: Record<SiteLang, MainCopy> = {
  ja: {
    ...
    lead: "歩いて見つけたことをシーンとして残します。読み返すたび、同じ道が少し違って見えてきます。",
    myNotebookLabel: "最近のシーン",
    myNotebookEmpty: "まだ何も残っていません。最初のシーンを残すと、ここから積み上がります。",
    myPlacesLabel: "よく歩く場所",
    nearbyLabel: "近くで見つかっているもの",
    nearbyEmpty: "近くの観察レコードはまだありません。あなたのシーンが、この場所の最初のページになります。",
    ctaLoggedIn: JA_PUBLIC_SHARED_COPY.cta.openNotebook,
    ctaGuest: JA_PUBLIC_SHARED_COPY.cta.record,
    ambientLabel: "同じ場所を歩いている人",
    ambientEmpty: "まだ誰も残していません。あなたが 1 シーン目になれます。",
    ...
    walkLabel: "今日のシーン",
    walkNoActivity: "まだ今日のシーンがありません",
    walkDistUnit: "m",
    placeFirstVisit: "この場所の最初のページ",
    placeComparedOn: (date) => `前回 ${date}`,
    placeNextLook: (focus) => `次は ${focus}`,
    placeNextFallback: "次の散歩で小さな変化を 1 つ残す",
    placeRecordLabel: "ここでシーンを残す",
  },
  en: {
