...
const mainCopy: Record<SiteLang, MainCopy> = {
  ja: {
    eyebrow: "あなたの 1 冊",
    heading: "📖 フィールドノート",
    lead: "歩いて見つけた生きものと場所、他の人の観察につけた同定も、1 冊のノートに積み上げる。あとから読み返すほど、同じ道が違って見えてくる。",
    ...
    nearbyEmpty: "近くの観察がまだありません。あなたが 1 件書くと、この場所のノートが育ち始めます。",
    ctaLoggedIn: "続きを書く",
    ctaGuest: "あなたのノートを始める",
    ambientLabel: "同じ場所を歩いている人たち",
    ambientEmpty: "まだ誰もノートを開いていません。あなたが 1 件目になれます。",
    seeMore: "ノート全体を開く",
  },
  en: {
