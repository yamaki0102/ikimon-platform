...
const copyByLang: Record<SiteLang, TodayHabitCopy> = {
  ja: {
    eyebrow: "今日のあなた",
    guestHeading: "今日の 1 シーンが、続きをつくる",
    guestLead: "シーンを始めると、今日／今週／次の 1 枚の理由がここに並ぶ。最初のシーンから、同じ道の見え方が変わり始める。",
    guestCta: "最初のシーンを残す",
    loggedInEyebrow: "今日のあなた",
    loggedInHeadingToday: (count) => `今日、${count} シーン残せた。いい 1 日だ。`,
    loggedInHeadingNoToday: "今日はまだ、1 シーンも残していない。",
    loggedInLeadFresh: (streak) => `${streak} 日、残し続けている。ここから同じ道の見え方が変わり始める。`,
    loggedInLeadResting: (lastDays) => `前回から ${lastDays} 日。同じ場所でも、季節は確実に動いている。`,
    loggedInLeadFirstTime: "最初のシーンを残せば、あなたの続きがここから立ち上がる。",
    weekLabel: (count) => `今週 ${count} シーン`,
    streakLabel: (days) => `${days} 日続けて`,
    nudgeWriteToday: "今日のシーンを残す",
    nudgeKeepStreak: (next) => `もう 1 シーンで、${next} 日続けて`,
    nudgeReturn: (gap) => `${gap} 日ぶりにシーンを残す`,
    nudgeFirstPage: "最初のシーンを残す",
    ctaContinue: "続きを残す",
    ctaReturn: "また残す",
    ctaStart: "始める",
  },
