...
const copyByLang: Record<SiteLang, TodayHabitCopy> = {
  ja: {
    eyebrow: "今日のあなた",
    guestHeading: "今日の 1 枚が、続きをつくる",
    guestLead: "ノートを始めると、今日／今週／次の 1 枚の理由がここに並ぶ。最初の 1 ページから、同じ道の見え方が変わり始める。",
    guestCta: "最初の 1 枚を書く",
    loggedInEyebrow: "今日のあなた",
    loggedInHeadingToday: (count) => `今日、${count} 枚書けた。いい 1 日だ。`,
    loggedInHeadingNoToday: "今日はまだ、1 枚も書いていない。",
    loggedInLeadFresh: (streak) => `${streak} 日、書き続けている。ここから同じ道の見え方が変わり始める。`,
    loggedInLeadResting: (lastDays) => `前回から ${lastDays} 日。同じ場所でも、季節は確実に動いている。`,
    loggedInLeadFirstTime: "最初の 1 枚を書けば、あなたの続きがここから立ち上がる。",
    weekLabel: (count) => `今週 ${count} 枚`,
    streakLabel: (days) => `${days} 日続けて`,
    nudgeWriteToday: "今日の 1 枚を書く",
    nudgeKeepStreak: (next) => `もう 1 枚で、${next} 日続けて`,
    nudgeReturn: (gap) => `${gap} 日ぶりに 1 枚`,
    nudgeFirstPage: "最初の 1 枚を書く",
    ctaContinue: "続きを書く",
    ctaReturn: "また書く",
    ctaStart: "始める",
  },
