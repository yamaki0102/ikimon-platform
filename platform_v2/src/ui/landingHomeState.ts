...
@media(max-width:767px){.home-state-view.is-guest .home-guest-owner-photo img{aspect-ratio:1/1}}
@media(max-width:767px){.home-state-view.is-guest .home-guest-hero{gap:12px}}
@media(min-width:720px) and (max-width:959px){.home-state-view.is-guest .home-guest-hero{grid-template-columns:minmax(0,.82fr) minmax(320px,1.18fr);align-items:center;gap:32px}.home-state-view.is-guest .home-guest-owner-photo img{aspect-ratio:6/5}}
`;
