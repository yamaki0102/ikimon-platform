...
const SEEDED_HAMAMATSU_CARDS: RegionalKnowledgeCard[] = [
  ...
  },
  {
    ...
    title: "浜松城と城下の移り変わり",
    summary: "城絵図や城下絵図は、今の中心部を近世から近代のまちの変化として確認する手がかりになります。",
  ...
  },
  {
    ...
    category: "cultural_asset",
    title: "文化財一覧から場所を見る",
    summary: "浜松市の文化財一覧は、身近な場所を文化財や地域資料の入口として確認する手がかりです。",
...
const EXPANDED_HAMAMATSU_CARDS: RegionalKnowledgeCard[] = [
  {
    ...
    category: "water",
    title: "馬込川が流れるまち",
    summary: "曳馬地区の文化誌は、馬込川を軸に地域の暮らしや地形を確認する入口になります。",
    sourceUrl: "https://adeac.jp/hamamatsu-city/text-list",
    sourceLabel: "浜松市文化遺産デジタルアーカイブ テキスト一覧",
    license: "出典先の利用規定に従う",
    tags: ["曳馬", "馬込川", "水辺", "文化誌"],
  ...
  },
  {
    ...
    category: "water",
    title: "積志の流れ今むかし",
    summary: "積志地区の文化誌は、水の流れ、集落、道の変化を観察の背景として確認できます。",
    sourceUrl: "https://adeac.jp/hamamatsu-city/text-list",
    sourceLabel: "浜松市文化遺産デジタルアーカイブ テキスト一覧",
    license: "出典先の利用規定に従う",
    tags: ["積志", "水の流れ", "集落", "文化誌"],
  ...
  },
  {
    ...
    category: "history",
    title: "絵図・地図",
    summary: "ADEACの絵図・地図資料は、今の道、水辺、町割りを昔の位置感覚で確認する入口です。",
    sourceUrl: "https://adeac.jp/hamamatsu-city/top/",
...
function buildRegionalStoryGeminiPrompt(
  ...
  return JSON.stringify({
    ...
    outputSchema: {
      ...
      collective_note: "string <= 160 chars — How a second record from the same spot adds to a community-built picture. Tie it to a near-future change the reader can witness (季節差, 管理跡, 水位, 開花段階). Avoid '生物多様性データに記録' のような抽象表現。",
    },
