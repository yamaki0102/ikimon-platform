...
export const AI_MODEL_ROLE_CHAINS = {
  ...
  observationVisualExtract: [
    AI_MODEL_ROLE_REFS.observationVisualExtractPrimary,
    AI_MODEL_ROLE_REFS.observationVisualExtractFallback,
    AI_MODEL_ROLE_REFS.observationVisualSummaryPrimary,
  ],
  observationVisualSummary: [AI_MODEL_ROLE_REFS.observationVisualSummaryPrimary, AI_MODEL_ROLE_REFS.observationVisualExtractPrimary],
