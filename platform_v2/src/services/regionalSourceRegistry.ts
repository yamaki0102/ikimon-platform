...
export const REGIONAL_PUBLISHERS: readonly RegionalPublisher[] = [
  ...
  {
    publisherId: "publisher:inabe-city",
    name: "いなべ市",
    kind: "municipality",
    officialUrl: "https://www.city.inabe.mie.jp/",
  },
  {
...
export const REGIONAL_SOURCE_ASSETS: readonly RegionalSourceAsset[] = [
  ...
  {
    sourceAssetId: "source:inabe:green-map:2026",
    title: "Inabe Green Map いなべの自然とあそぶ",
    publisherIds: ["publisher:inabe-city"],
    geographicScopes: ["place:jp-mie-inabe"],
    canonicalUrl: "https://www.city.inabe.mie.jp/_res/projects/default_project/_page_/001/015/388/map.pdf",
    format: "pdf",
    rightsClass: "INDEX_ONLY",
    state: "RIGHTS_CLASSIFIED",
    issuedAt: "2026-03-01",
    ...
    language: "ja",
    licenseLabel: null,
    notes: "いなべ市公式ページで公開。自然体験フィールド、推奨季節、アクセス・安全情報、危険生物、持ち物・応急手当、参加型アプリ・プロジェクト、寄稿・発行情報を含む。事実抽出候補として扱い、本文・写真・イラスト・紙面は権利確認なしに再掲載しない。",
  },
  {
