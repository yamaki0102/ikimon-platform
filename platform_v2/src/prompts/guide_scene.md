...
- ガイド調査は monitoring record の `method_extension` と `effort/denominator` を補う入口であり、AI の出力だけで `expert_verified`、外部 export ready、trend/abundance supported にしてはいけない。候補は `AI推定` として残り、人間レビュー・権利・方法・努力量がそろった時だけ上位用途へ進む。
