...
export const SITE_PAGE_DEFINITIONS: SitePageDefinition[] = [
  ...
  },
  {
    ...
    summary: {
      ja: "ikimon.life と IKIMON の挑戦を支えるCREW。",
      en: "A CREW membership that supports ikimon.life and IKIMON.",
    },
  ...
  },
  {
    ...
    auth: "public",
    navVisibility: ["footer", "qa", "xml"],
    title: { ja: "IKIMON CREW紹介ページ案", en: "IKIMON CREW introduction concept" },
    summary: {
      ja: "CREWとして参加してくれた人、会社、団体を紹介するページ案とリンク用バナー案。",
      en: "A concept page and banner ideas for introducing IKIMON CREW members.",
    },
    primaryAction: { href: "/crew", label: { ja: "CREW本ページを見る", en: "Back to CREW" } },
    marketing: { pageKey: "crewMembers" },
    visualQa: {
      smoke: true,
      viewports: ["desktop-1440", "mobile-390"],
      expectedText: { ja: "リンク用バナー案", en: "Banner concepts" },
      readySelector: "body",
      screenshot: { baselineName: "registry-crew-members" },
    },
  },
  {
    path: "/community",
