...
export const SITE_PAGE_DEFINITIONS: SitePageDefinition[] = [
  {
    ...
    summary: { ja: "ikimon - 皆で作る地域図鑑の入口。地域の自然・風景・水・土・農・季節・活動を地図から開く。", en: "The map-first entry point for building a regional field guide together." },
  ...
  },
  {
    ...
    summary: { ja: "保護区以外で生物多様性保全に関わる地域を評価する考え方。", en: "A plain-language term page for OECM." },
