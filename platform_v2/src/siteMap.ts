...
export const SITE_PAGE_DEFINITIONS: SitePageDefinition[] = [
  ...
  },
  {
    ...
    summary: { ja: "自分の発見、場所、再訪のきっかけを見返す。", en: "Review places and reasons to revisit." },
  ...
  },
  {
    ...
    auth: "public",
    navVisibility: ["footer", "qa", "xml"],
    title: { ja: "BioMonWeekで観察する", en: "BioMonWeek field guide" },
    summary: { ja: "初回BioMonWeekを、参加しやすく来年比べられる記録へつなぐ。", en: "A lightweight field guide for first-year BioMonWeek participation." },
  ...
  },
  {
    ...
    summary: { ja: "一定期間にみんなで生物多様性の観察記録を集める観察ウィーク。", en: "A plain-language term page for BioMonWeek." },
  ...
  },
  {
    ...
    auth: "public",
    navVisibility: ["footer", "qa", "xml"],
    title: { ja: "quick captureとは", en: "Quick capture" },
