...
export const SITE_PAGE_DEFINITIONS: SitePageDefinition[] = [
  {
    ...
    summary: { ja: "ikimon - 皆で作る地域図鑑の入口。地域の自然・風景・水・土・農・季節・活動を地図から確認する。", en: "The map-first entry point for building a regional field guide together." },
  ...
  },
  {
    ...
    summary: { ja: "ライブガイドで見つけたことを、今日できたことと次の一歩に絞って確認する。", en: "Review what Guide captured and choose one next step." },
  ...
  },
  {
    ...
    summary: { ja: "保護区以外で生物多様性保全に効果がある地域を評価する考え方。", en: "A plain-language term page for OECM." },
