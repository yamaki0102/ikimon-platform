...
export const SITE_PAGE_DEFINITIONS: SitePageDefinition[] = [
  ...
  },
  {
    ...
    primaryAction: { href: "/record", label: { ja: "シーンを残す", en: "Record" } },
  ...
  },
  {
    ...
    auth: "public",
    navVisibility: ["header", "footer", "qa", "xml"],
    title: { ja: "シーン", en: "Notes" },
    summary: { ja: "自分の発見、場所、再訪のきっかけをシーンとして見返す。", en: "Review places and reasons to revisit." },
    visualQa: { smoke: true, viewports: ["desktop-1440", "mobile-390"], expectedText: { ja: "シーン" }, readySelector: "body", screenshot: { baselineName: "registry-notes" } },
  },
  {
    path: "/home",
    lane: "start",
