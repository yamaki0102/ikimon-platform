...
export const SITE_PAGE_DEFINITIONS: SitePageDefinition[] = [
  ...
  },
  {
    ...
    auth: "public",
    navVisibility: ["footer", "qa", "xml"],
    title: { ja: "IKIMON CREW紹介", en: "IKIMON CREW" },
    summary: {
      ja: "CREWとして参加してくれた人、会社、団体をロゴやリンクで紹介するページ。",
      en: "A logo-and-link showcase for IKIMON CREW members.",
    },
    ...
    visualQa: {
      smoke: true,
      viewports: ["desktop-1440", "mobile-390"],
      expectedText: { ja: "All CREW", en: "All CREW" },
      readySelector: "body",
