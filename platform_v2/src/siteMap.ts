...
export const SITE_PAGE_DEFINITIONS: SitePageDefinition[] = [
  ...
  },
  {
    ...
    visualQa: { smoke: true, viewports: ["desktop-1440", "mobile-390"], expectedText: { ja: "まず写真から分かること" }, requires: "occurrence", allowStatus: [200, 404], screenshot: { baselineName: "registry-observation-detail" } },
  },
  {
    path: "/learn",
    lane: "learn",
