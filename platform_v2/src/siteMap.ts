...
export const SITE_PAGE_DEFINITIONS: SitePageDefinition[] = [
  ...
  },
  {
    ...
    auth: "session",
    navVisibility: ["qa"],
    title: { ja: "観察会を作る", en: "Create an observation event" },
    summary: { ja: "場所・日時・参加方法を決め、主催者として観察会を始める。", en: "Set the place, time, and participation mode to start an event as its organizer." },
    primaryAction: { href: "/community/events", label: { ja: "観察会一覧", en: "Browse events" } },
  },
  {
    path: "/community/events/:eventCode/join",
    lane: "group",
    layout: "wide",
    audience: "member",
    auth: "session",
    navVisibility: ["qa"],
    title: { ja: "観察会に参加", en: "Join an observation event" },
    summary: { ja: "主催者から受け取った案内で参加し、記録を始める。", en: "Join from the organizer's invitation and begin recording." },
    primaryAction: { href: "/community/events", label: { ja: "観察会一覧", en: "Browse events" } },
  },
  {
    path: "/events/:sessionId/console",
    lane: "group",
    layout: "wide",
    audience: "member",
    auth: "session",
    navVisibility: ["qa"],
    title: { ja: "観察会の管制塔", en: "Event organizer console" },
    summary: { ja: "参加案内と当日の進行を主催者が確認する。", en: "Organizers manage invitations and event progress." },
    primaryAction: { href: "/community/events", label: { ja: "観察会一覧", en: "Browse events" } },
  },
  {
    path: "/events/:sessionId/recap",
    lane: "group",
    layout: "reading",
    audience: "member",
    auth: "session",
    navVisibility: ["qa"],
    title: { ja: "観察会の振り返り", en: "Event recap" },
    summary: { ja: "記録と参加の成果を安全な範囲で振り返り、再開催へつなげる。", en: "Review event results within safe boundaries and start another event." },
    primaryAction: { href: "/community/events", label: { ja: "観察会一覧", en: "Browse events" } },
  },
  {
