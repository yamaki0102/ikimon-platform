...
ikimon.life は「市民が楽しんで見つけた生きものを、研究・地域活動・レポートで扱える記録へ育てる」ための基盤です。[AI候補](/learn/terms/ai-candidate)、市民の[同定](/learn/terms/identification)、[open dispute](/learn/terms/open-dispute)、専門家レビューを同じ履歴に残し、どの記録をどの強さで使えるかを段階分けします。
...
そのため ikimon.life は「研究や TNFD に使える」と雑に断言しません。**市民記録を、分類合意・反対意見・専門確認まで追跡できる地域生物データ基盤**として扱います。
...
企業や自治体のレポートでは、観察の楽しさだけでなく、継続性、参加性、説明責任が必要です。ikimon.life では、参加者が残した記録を、対象場所、期間、同定状態、公開範囲、努力量の有無と一緒に整理します。
