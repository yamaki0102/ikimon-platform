...
ikimon.life は、もっと手前から始めます。いつもの道で見つけた花、通学路で聞こえた鳥の声、庭先に来た虫、旅先で出会った生きもの。そうした小さな発見を楽しみ、あとで開ける形に残すことから、地域の自然との関係を取り戻していきます。
...
TNFD、30by30、ネイチャーポジティブの文脈でも、必要なのは大きな言葉だけではありません。どの場所で、誰が、何を見つけ、どのように確認しているか。その積み重ねが、説明責任の土台になります。
...
- [記録を見る](/records): 自分の発見、公開観察、再訪したい場所を確認する
