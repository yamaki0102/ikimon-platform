...
BioMonWeekのような観察ウィークでは、まず参加しやすいことが重要です。そのうえで、同じ場所をもう一度見る、観察努力量を残す、ベースラインとして翌年以降に比べる、という流れにできると価値が伸びます。
...
関連: [BioMonWeek](/learn/terms/biomonweek), [生物多様性モニタリング](/learn/terms/biodiversity-monitoring), [市民参加型モニタリング](/learn/terms/participatory-monitoring), [観察努力量](/learn/terms/sampling-effort)
