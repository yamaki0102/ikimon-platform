...
- **エリアの記憶を再設計**: 同じ場所の写真や記録を、一覧できる形で残し、再訪につなげやすくしました。
- **生物多様性バッジを追加**: 地図上のエリアで、記録量や見どころを直感的に見られる表示を追加しました。
...
**エリアの変化が見えるようにし、トップページを軽く**

- **記録フィードバックを追加**: ある場所への記録で、そのエリアの理解に何が加わったかを返しやすくしました。
...
- **投稿後の受け取り表示を追加**: 記録で何が見えたか、次に何を残すとよいかを返す準備を進めました。
...
- **公開面の安全性を強化**: お問い合わせの連続送信を制限し、ブラウザ側の保護ヘッダーを追加して、公開サイトの保護を強めました。
...
- **入口の言葉を整理**: 「AIがすごい」ではなく、散歩中に気になったものを確かめ、あとで確認できる記録に残すための説明に寄せました。
...
- **バッジ・スコア本格稼働**: 記録数、同定参加、連続投稿などに応じた達成表示を追加しました。
...
- **参考インデックス**: 観測記録量と保全シグナルを自動要約しました。
