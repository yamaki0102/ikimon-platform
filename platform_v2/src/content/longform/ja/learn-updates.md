...
ZUKAN の更新は、単なる機能追加ではなく「近くの自然を見つける、確かめる、残す、また歩く」を軽くするために積み重ねています。旧本番で公開していた履歴も残しながら、現在の公開サイトで変わった見せ方を上に追記しています。
...
- **公開ページを追加**: ZUKAN の活用イメージを伝える事例・インパクトページを追加しました。
...
- **おすすめ調査エリア**: GBIF・iNaturalist の広域データと ZUKAN のローカルデータを比較し、発見チャンスが高い場所を地図上に出す方向へ進めました。
...
**Androidアプリ ZUKAN Pocket + 世界11,560種の音声AI同定**

- **ZUKAN Pocket Android版**: カメラ検出、音声同定、ウォークモードをネイティブアプリとして使える APK を公開しました。
