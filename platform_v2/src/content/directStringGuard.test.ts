...
const explicitAllowlist = [
  ...
  "platform_v2/src/routes/personalLibrary.ts",
  "platform_v2/src/routes/personalLibraryCopy.ts",
  ...
  "platform_v2/src/ui/appExperience.ts",
  "platform_v2/src/ui/collaborationContext.ts",
  ...
  "platform_v2/src/ui/participationTerms.ts",
  ...
  "platform_v2/src/ui/observationOwnerDelete.ts",
  "platform_v2/src/ui/officialNoticeCard.ts",
  "platform_v2/src/ui/placeFeelingTagDemo.ts",
