...
function validateLandingCopy(value: unknown, path: string): asserts value is JsonLandingCopy {
  ...
  for (const key of [
    "heroHeading", "heroLead", "primaryCta", "secondaryCta", "categoriesTitle", "proofEmpty", "proofEmptyNote", "publicRecordsCta", "inviteNote", "recordStatusConfirmed", "recordStatusPending", "recordStatusLimited", "emptyFlowAria", "emptyFlowCapture", "emptyFlowPlace", "emptyFlowReturn", "flowTitle",
    "placesTitle", "placesBody", "communityTitle", "communityBody", "communityCta", "privacyTitle", "privacyBody", "finalTitle", "finalCta",
  ] as const) {
  ...
  for (const key of [
    ...
    "watchUpdatesUpdated", "watchUpdatesVerified", "recentTitle", "recentCta", "placesTitle", "placesCta",
