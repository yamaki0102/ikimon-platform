# Claude Opus Prompt — SZ-UC-02

以下をそのまま実行してください。

---

ikimon.life の UX テストを 1 ケースだけ実行してほしい。今回の対象は **SZ-UC-02 下田の親子が磯遊び記録を残す**。

## 最初に読むファイル

1. `C:\Users\YAMAKI\Documents\Playground\AGENTS.md`
2. `C:\Users\YAMAKI\Documents\Playground\docs\spec\shizuoka-ux-test-cases\02_shimoda_family_tidepool_trip.md`
...
4. ケースファイルの前提条件に沿って、家族レジャー文脈で連続投稿を検証する
5. 合格条件と失敗シグナルを埋める
6. 結果を次のファイルに保存する

`C:\Users\YAMAKI\Documents\Playground\docs\review\shizuoka-ux-tests\SZ-UC-02_report.md`
