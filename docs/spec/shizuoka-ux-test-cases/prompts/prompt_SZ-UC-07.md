# Claude Opus Prompt — SZ-UC-07

以下をそのまま実行してください。

---

ikimon.life の UX テストを 1 ケースだけ実行してほしい。今回の対象は **SZ-UC-07 安倍川で外来種モニタリングを継続する**。

## 最初に読むファイル

1. `C:\Users\YAMAKI\Documents\Playground\AGENTS.md`
2. `C:\Users\YAMAKI\Documents\Playground\docs\spec\shizuoka-ux-test-cases\07_abekawa_invasive_species_monitoring.md`
...
4. ケースファイルの前提条件に沿って、継続観察の再訪性と精度を中心に検証する
5. 合格条件と失敗シグナルを埋める
6. 結果を次のファイルに保存する

`C:\Users\YAMAKI\Documents\Playground\docs\review\shizuoka-ux-tests\SZ-UC-07_report.md`
