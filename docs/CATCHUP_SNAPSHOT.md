...
| Current app routes | 86 |
| Current app services | 331 |
| Current app UI helpers | 57 |
| Current app content files | 87 |
| Current app tests | 211 |
| Current app E2E specs | 25 |
...
- platform_v2\src\routes/ : 86 files
- platform_v2\src\scripts/ : 110 files
- platform_v2\src\services/ : 331 files
- platform_v2\src\types/ : 1 files
- platform_v2\src\ui/ : 57 files

## Largest Route Files

| File | Size KB |
|---|---:|
| platform_v2\src\routes\read.ts | 1099.9 |
| platform_v2\src\routes\guideRecordsDebug.ts | 91.1 |
| platform_v2\src\routes\marketing.ts | 75.2 |
| platform_v2\src\routes\observationDetailFriendlyCopy.test.ts | 68.7 |
| platform_v2\src\routes\write.ts | 51.6 |
...
| platform_v2\src\routes\ops.ts | 36.5 |
| platform_v2\src\routes\researchApi.ts | 33.6 |

## Largest Service Files

| File | Size KB |
|---|---:|
| platform_v2\src\services\observationReassess.ts | 117.7 |
| platform_v2\src\services\landingSnapshot.ts | 85.5 |
| platform_v2\src\services\readModels.ts | 80.8 |
...
| platform_v2\src\services\observationWrite.ts | 42.3 |
