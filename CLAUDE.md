...
詳細: `docs/strategy/fieldscan_100y_archive_strategy.md`
...
| **Phase 16** | **100年アーカイブ基盤 + FieldScan統合** | 🔲 計画済 |

### Phase 16: 100年アーカイブ基盤（計画概要）
- FieldScan 連携: TFLite種同定 + Perch v2鳥音声 + 環境センサー → タイムカプセル生成
...
- 詳細: `docs/strategy/fieldscan_implementation_roadmap.md`
