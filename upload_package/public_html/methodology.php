...
<main class="max-w-4xl mx-auto px-6 py-20 pb-32">
    ...
    <nav class="mb-16 p-6 rounded-2xl bg-surface border border-border">
        ...
        <ol class="space-y-2 text-sm font-medium">
            ...
            <li><a href="#academic-alignment" class="text-[var(--color-primary)] hover:underline flex items-center gap-2"><i data-lucide="graduation-cap" class="w-4 h-4"></i>学術的背景と設計整合</a></li>
        </ol>
    </nav>
    ...
    <div class="space-y-24">
            ...
            <div class="space-y-6">
                ...
                <div class="p-6 rounded-2xl bg-surface border border-border">
                    ...
                    <ul class="space-y-2 text-sm text-muted leading-relaxed">
                        <li class="flex items-start gap-2">
                            ...
                            ライブスキャン中のカメラフレームは AI 同定後に<strong class="text-text">自動削除</strong>されます
                        </li>
                        <li class="flex items-start gap-2">
                            <i data-lucide="check" class="w-4 h-4 text-green-400 mt-0.5 shrink-0"></i>
                ...
                <div class="p-6 rounded-2xl bg-surface border border-border">
                    ...
                    <ul class="space-y-2 text-sm text-muted leading-relaxed">
                        <li class="flex items-start gap-2">
                            <i data-lucide="check" class="w-4 h-4 text-green-400 mt-0.5 shrink-0"></i>
                            GPS 座標は生態学的な精度を保つため、可能な限り<strong class="text-text">高精度で記録</strong>されます
                        </li>
                        <li class="flex items-start gap-2">
                            <i data-lucide="check" class="w-4 h-4 text-green-400 mt-0.5 shrink-0"></i>
                ...
                <div class="p-6 rounded-2xl bg-surface border border-border">
                    ...
                    <ul class="space-y-2 text-sm text-muted leading-relaxed">
                        <li class="flex items-start gap-2">
                            <i data-lucide="check" class="w-4 h-4 text-green-400 mt-0.5 shrink-0"></i>
                            投稿された観察記録は <strong class="text-text">CC BY-NC 4.0</strong> ライセンスで共有されます
                        </li>
                        <li class="flex items-start gap-2">
                            <i data-lucide="check" class="w-4 h-4 text-green-400 mt-0.5 shrink-0"></i>
        ...
        <section id="mri-overview" class="scroll-target">
            ...
            <div class="p-8 rounded-2xl bg-surface border border-border mb-8">
                <p class="text-muted leading-relaxed mb-6">
                    モニタリング参考インデックス（MRI）は、ikimon が独自に開発した<strong class="text-text">市民科学データに基づく生物多様性の参考指標</strong>です。
                    サイト（観察地点）に集まった観察データを 5 つの軸で多角的に評価し、0〜100 のスコアとして算出します。
                </p>
                <div class="grid grid-cols-3 gap-4 text-center">
                    <div class="p-4 rounded-xl bg-base">
            ...
            <p class="text-sm text-muted leading-relaxed">
                ...
                モニタリングの進捗を可視化し、経時変化を追跡するための<strong class="text-text">対話のきっかけ</strong>として設計されています。
            </p>
        </section>
        ...
        <section id="five-axes" class="scroll-target">
            ...
            <div class="space-y-4">
                ...
                <div class="axis-card p-6 rounded-2xl bg-surface border border-border">
                    ...
                    <div class="w-full bg-base rounded-full overflow-hidden">
            ...
            <div class="p-8 rounded-2xl bg-amber-900/10 border border-amber-600/20">
                ...
                <ul class="space-y-4 text-sm">
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            <strong class="text-text">認証スコアではありません</strong>
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            <strong class="text-text">観測努力の影響を受けます</strong>
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            <strong class="text-text">存在記録ベースです</strong>
                    ...
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            <strong class="text-text">クレジット価格に直結しません</strong>
        ...
        <section id="open-science" class="scroll-target">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                ...
                <div class="p-6 rounded-2xl bg-surface border border-border">
                    ...
                    <p class="text-sm text-muted leading-relaxed">
                        TNFD LEAP フレームワークおよび 30by30 目標に沿った指標設計を行っています。
                        将来的な国際標準への対応を視野に入れています。
                    </p>
                </div>
            ...
            <div class="mt-8 p-6 rounded-2xl bg-surface border border-border">
                <div class="flex items-center gap-2 mb-4">
                    <i data-lucide="cpu" class="w-5 h-5 text-[var(--color-primary)]"></i>
                    <h3 class="text-base font-bold">AI モデル・技術クレジット</h3>
                </div>
                <div class="space-y-3 text-sm text-muted leading-relaxed">
                    <div class="flex items-start gap-3 p-3 rounded-xl bg-[var(--color-bg)]">
                        <div class="shrink-0 w-8 h-8 rounded-lg bg-green-500/15 flex items-center justify-center mt-0.5">
                            <i data-lucide="bird" class="w-4 h-4 text-green-400"></i>
                        </div>
                        <div>
                            <p class="font-semibold text-text">Powered by BirdNET+</p>
                            <p>
                                音声による種同定には
                                <a href="https://birdnet.cornell.edu/" target="_blank" rel="noopener" class="text-[var(--color-primary)] hover:underline">BirdNET+</a>
                                V3.0（11,560 種対応）を使用しています。
                                Cornell Lab of Ornithology、Chemnitz University of Technology、Museum für Naturkunde Berlin の共同開発。
                            </p>
                            <p class="mt-1 text-xs opacity-70">
                                モデルライセンス:
                                <a href="https://creativecommons.org/licenses/by-sa/4.0/" target="_blank" rel="noopener" class="text-[var(--color-primary)] hover:underline">CC BY-SA 4.0</a>
        ...
        <!-- ==============================
             6. 学術的背景と設計整合
        ============================== -->
        <section id="academic-alignment" class="scroll-target">
            <div class="flex items-center gap-3 mb-8">
                ...
                <h2 class="text-2xl font-black">学術的背景と設計整合</h2>
            </div>

            <p class="text-sm text-muted leading-relaxed mb-6">
                Sutherland et al. (2026-03-04, PNAS) は、生物多様性計測の抜本的変革に必要な9つの提言を示しました。
                ikimon の設計は、このうち少なくとも7項目と整合しています。
            </p>

            <div class="grid md:grid-cols-2 gap-3">
                <div class="p-4 rounded-xl bg-surface border border-border">
                    <div class="flex items-center gap-2 mb-2">
                        <span class="w-6 h-6 rounded-full bg-emerald-500/15 text-emerald-500 text-xs font-black flex items-center justify-center">1</span>
                        <h3 class="text-sm font-bold">異種データソース統合</h3>
                    </div>
                    <p class="text-xs text-muted">画像・音声・GPS・環境センサーを Canonical Schema で統一管理</p>
                </div>

                <div class="p-4 rounded-xl bg-surface border border-border">
                    <div class="flex items-center gap-2 mb-2">
                        <span class="w-6 h-6 rounded-full bg-emerald-500/15 text-emerald-500 text-xs font-black flex items-center justify-center">2</span>
                        <h3 class="text-sm font-bold">データ収集の標準化</h3>
                    </div>
                    <p class="text-xs text-muted">Evidence Tier による段階的品質管理と DarwinCore 準拠スキーマ</p>
                </div>

                <div class="p-4 rounded-xl bg-surface border border-border">
                    <div class="flex items-center gap-2 mb-2">
                        <span class="w-6 h-6 rounded-full bg-emerald-500/15 text-emerald-500 text-xs font-black flex items-center justify-center">3</span>
                        <h3 class="text-sm font-bold">新旧データの較正</h3>
                    </div>
                    <p class="text-xs text-muted">AI 初期判定（Tier 1）と人間検証（Tier 2+）を構造的に分離</p>
                </div>

                <div class="p-4 rounded-xl bg-surface border border-border">
                    <div class="flex items-center gap-2 mb-2">
                        <span class="w-6 h-6 rounded-full bg-emerald-500/15 text-emerald-500 text-xs font-black flex items-center justify-center">4</span>
                        <h3 class="text-sm font-bold">地理的データギャップ解消</h3>
                    </div>
                    <p class="text-xs text-muted">パッシブ観察で参加障壁を下げ、日本全国の面的カバーを拡大</p>
                </div>

                <div class="p-4 rounded-xl bg-surface border border-border">
                    <div class="flex items-center gap-2 mb-2">
                        <span class="w-6 h-6 rounded-full bg-emerald-500/15 text-emerald-500 text-xs font-black flex items-center justify-center">5</span>
                        <h3 class="text-sm font-bold">信頼された生きたデータベース</h3>
                    </div>
                    <p class="text-xs text-muted">Validation Workbench — L0-L3 レビュアー階層と監査証跡</p>
                </div>

                <div class="p-4 rounded-xl bg-surface border border-border">
                    <div class="flex items-center gap-2 mb-2">
                        <span class="w-6 h-6 rounded-full bg-emerald-500/15 text-emerald-500 text-xs font-black flex items-center justify-center">6</span>
                        <h3 class="text-sm font-bold">データ生成の価値評価</h3>
                    </div>
                    <p class="text-xs text-muted">バッジ・スコア・リーダーボードによる貢献可視化</p>
                </div>

                <div class="p-4 rounded-xl bg-surface border border-amber-500/30">
                    <div class="flex items-center gap-2 mb-2">
                        <span class="w-6 h-6 rounded-full bg-amber-500/15 text-amber-500 text-xs font-black flex items-center justify-center">7</span>
                        <h3 class="text-sm font-bold">地域知識の統合</h3>
                    </div>
                    <p class="text-xs text-muted">今後の強化領域 — 地方創生戦略と接続して取り組み予定</p>
                </div>

                <div class="p-4 rounded-xl bg-surface border border-amber-500/30">
                    <div class="flex items-center gap-2 mb-2">
                        <span class="w-6 h-6 rounded-full bg-amber-500/15 text-amber-500 text-xs font-black flex items-center justify-center">8</span>
                        <h3 class="text-sm font-bold">介入効果の定量化</h3>
                    </div>
                    <p class="text-xs text-muted">今後の強化領域 — BIS 時系列と介入記録の接続を計画中</p>
                </div>

                <div class="p-4 rounded-xl bg-surface border border-border md:col-span-2">
                    <div class="flex items-center gap-2 mb-2">
                        <span class="w-6 h-6 rounded-full bg-emerald-500/15 text-emerald-500 text-xs font-black flex items-center justify-center">9</span>
                        <h3 class="text-sm font-bold">データセットの耐性強化</h3>
                    </div>
                    <p class="text-xs text-muted">GBIF エクスポート・DarwinCore Archive による冗長性とプラットフォーム非依存の永続性</p>
                </div>
            </div>

            <p class="text-xs text-faint mt-4">
                参考: Sutherland, W.J. et al. (2026-03-04) "Nine changes needed to deliver a radical transformation in biodiversity measurement." <em>PNAS</em>, 123(10).
                DOI: 10.1073/pnas.2519345123 —
                <a href="century_archive.php" class="text-[var(--color-primary)] hover:underline">詳細は「記録が保全に変わる理由」へ</a>
            </p>
        </section>
    ...
    <div class="mt-20 text-center space-y-4">
        ...
        <div class="flex flex-wrap justify-center gap-3">
            ...
            <a href="/" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-surface border border-border text-text font-bold text-sm hover:bg-elevated transition">
