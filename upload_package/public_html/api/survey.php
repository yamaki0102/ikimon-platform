...
if ($method === 'POST') {
    ...
    if ($action === 'start') {
        ...
        try {
            ...
            if ($weatherType) { $context['weather_type'] = $weatherType; $hasContextUpdate = true; }
            if ($tempRange)   { $context['temp_range'] = $tempRange; $hasContextUpdate = true; }
            if ($weatherLegacy && !$weatherType) { $context['weather'] = $weatherLegacy; $hasContextUpdate = true; }
            if ($ageGroup) { $context['age_group'] = $ageGroup; $hasContextUpdate = true; }
            if ($participantType) { $context['participant_type'] = $participantType; $hasContextUpdate = true; }
