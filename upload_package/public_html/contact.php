...
$meta_description = 'ikimonへのご質問・導入相談・共同実証のご相談・ご要望・バグ報告・データ削除のリクエストはこちらから。';
?>
<!DOCTYPE html>
<html lang="ja">
    ...
    <main class="max-w-2xl mx-auto px-6 py-20 pb-32">
        <header class="mb-12 text-center">
            ...
            <p class="text-gray-400 max-w-lg mx-auto leading-relaxed">
                ご質問・導入相談・共同実証のご相談・ご要望・バグ報告・データ削除のリクエストなど、お気軽にご連絡ください。
            </p>
        </header>
            ...
            <form x-show="!sent" @submit.prevent="submit()" class="space-y-5">
                ...
                <div>
                    ...
                    <p class="mt-2 text-xs leading-relaxed text-gray-400">
                        自治体・研究機関・企業・保全団体の方からの導入相談、現場に合わせた改善、共同実証のご相談もこちらから受け付けています。
                    </p>
                </div>
        ...
        function contactForm() {
            return {
                categories: [
                    ...
                    { value: 'partnership', icon: '🤝', label: '導入・連携' },
