        ...
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div class="lg:col-span-3">
                <div class="contact-card p-6 sm:p-8" x-data="contactForm()">
                    ...
                    <!-- Success state -->
                    <div :class="sent ? '' : 'hidden'" class="text-center py-8 hidden">
                    ...
                    <!-- Form -->
                    <form :class="sent ? 'hidden' : ''" @submit.prevent="submit()" class="space-y-6" novalidate>
                        ...
                        <!-- Global error -->
                        <div :class="globalError ? '' : 'hidden'"
                            class="flex items-center gap-2 p-3 rounded-xl bg-red-50 border border-red-100 text-red-600 text-sm hidden">
                        ...
                        <button type="submit"
                            ...
                            <svg :class="loading ? '' : 'hidden'" class="w-4 h-4 animate-spin hidden" viewBox="0 0 24 24" fill="none">
                                <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="3" stroke-dasharray="31.4 31.4" stroke-linecap="round" />
                            </svg>
                            <i data-lucide="send" class="w-4 h-4" :class="loading ? 'hidden' : ''" style="pointer-events:none"></i>
