...
$meta_description = '団体ページ・スポット登録・観察会の開催まで無料。種の全リストやCSV・レポート出力はPublicプランで。';
...
$features = [
    ...
    ['icon' => 'file-down', 'title' => '種一覧とレポートの出力', 'body' => '発見種の全リスト、CSV、証跡レポートなど、調査・報告に使う出力はPublicプランで利用できます。'],
];
...
$personas = [
    ...
    ['label' => '企業・CSR / ESG', 'icon' => 'building-2',
     'title' => '自然共生活動の記録と報告に',
     'body' => '活動の記録は残したいけど、最初から本格的なツールを導入するのは難しい。まずCommunityで記録を積んで、報告書が必要になったときにPublicへ切り替えられる設計にしています。',
     'plan' => 'Community → Public', 'cta' => 'Publicを相談する', 'href' => $publicCtaHref, 'tone' => 'tone-corp'],
    ['label' => '公園・施設運営', 'icon' => 'trees',
     'title' => '定期観察会の継続運営に',
     'body' => '担当者が変わるたびに「前回どこで何が見られたか」がわからなくなる。記録を団体ページに積み上げることで、引き継ぎのたびにゼロから始めなくて済む構造を目指しています。',
     'plan' => 'Community → Public', 'cta' => '団体ページを作る', 'href' => $workspaceCtaHref, 'tone' => 'tone-park'],
];
...
$plans = [
    ...
    ['name' => 'Community', 'price' => '¥0', 'suffix' => '', 'headline' => '団体ページを作って運営する', 'desc' => '法人格なしで作成可。観察会の開催まで無料。', 'features' => ['団体ページ・スポット登録・観察会開催', 'メンバー招待・QR参加・ランキング', '観察数・参加人数・発見種数の概要'], 'note' => '種の全リストと出力はPublicプランで。', 'cta' => $workspaceCtaLabel, 'href' => $workspaceCtaHref, 'variant' => 'community'],
    ['name' => 'Public', 'price' => '¥39,800', 'suffix' => '/ 月', 'headline' => '調査・報告用の出力を使う', 'desc' => '唯一の有料プラン。出力と詳細閲覧をすべて解放。', 'features' => ['種の全リストと要配慮種の詳細', 'CSV / 証跡JSON / 各種レポート出力', '継続運用サポート'], 'note' => 'Communityで運用を始めてから必要に応じて。', 'cta' => 'Publicを相談する', 'href' => $publicCtaHref, 'variant' => 'public'],
];
?>
<!DOCTYPE html>
<html lang="ja">
            ...
            <div class="lp-container">
                ...
                <div class="outcome-wrap">
                    <article class="card summary-card">
                        ...
                        <h3>個人も団体も、参加・運営まで無料。<br>出力が必要な時だけPublicへ。</h3>
        ...
        <section class="section" id="plans">
            <div class="lp-container">
                <div class="section-head">
                    ...
                    <h2>3つのプラン</h2>
                    <p>有料プランはPublicのみです。個人参加も団体運営も、出力以外はすべて無料でできます。</p>
                </div>
                <div class="grid-3">
        ...
        <section class="section">
            <div class="lp-container">
                ...
                <div class="closing">
                    ...
                    <p>現在プロトタイプを公開中です。Community プランは申込み不要・無料。フィードバックをもらいながら、一緒に育てていきたいと思っています。</p>
