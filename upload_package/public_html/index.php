...
$meta_title = 'ikimon — いつもの散歩が、冒険になる';
$meta_description = '道端の花の名前がわかると、世界の解像度が変わる。スマホで写真を撮って、名前を調べて、地図に記録。だれでも参加できる生きもの観察プラットフォーム。';
?>
<!DOCTYPE html>
<html lang="ja">
        ...
        <section class="hero-section relative">
            ...
            <div class="max-w-5xl mx-auto px-6 text-center relative z-10" style="padding-top:var(--phi-2xl);padding-bottom:var(--phi-xl)">
                ...
                <h1 class="font-black text-white" style="margin-bottom:var(--phi-sm)">
                    いつもの散歩が、<br class="md:hidden"><span class="text-emerald-300">冒険</span>になる。
                </h1>
                <p class="hero-sub max-w-xl mx-auto text-white/80" style="margin-bottom:var(--phi-lg)">
                    <span class="inline-block">道端の花の名前がわかると、</span><span class="inline-block">世界の解像度が変わる。</span><br class="md:hidden">
                    <span class="inline-block">歩いて、見つけて、</span><span class="inline-block">記録しよう。</span>
                </p>
        ...
        <section class="max-w-5xl mx-auto px-4 md:px-6" style="margin-top:var(--phi-2xl);margin-bottom:var(--phi-2xl)">
            ...
            <div class="flex flex-col gap-3 mb-6">
                ...
                <div class="flex items-center gap-2 overflow-x-auto scrollbar-hide -mx-1 px-1" role="tablist" aria-label="タイムラインフィルタ">
                    <a href="?filter=all" role="tab" aria-selected="<?php echo $filter === 'all' ? 'true' : 'false'; ?>" class="m3-chip <?php echo $filter === 'all' ? 'selected' : ''; ?>">すべて</a>
                    ...
                    <?php if ($currentUser): ?>
                        <a href="/profile.php" role="tab" aria-selected="false" class="m3-chip"><?php echo __('nav.profile'); ?></a>
                    <?php endif; ?>
                </div>
            </div>
