...
<div class="p-8 h-full overflow-y-auto custom-scrollbar pb-20">
    ...
    <div class="mb-12 animate-fade-in-up">
        <div class="flex items-center gap-3 mb-4">
            ...
            <div>
                <h1 class="text-3xl font-black text-gray-900 font-heading tracking-wide">デジタルツイン アーキテクチャ</h1>
                <p class="text-gray-500 font-mono text-sm">システム構成と環境価値算出ロジック</p>
            </div>
        </div>
    ...
    <div class="mb-16 animate-fade-in-up" style="animation-delay: 0.1s;">
        <h2 class="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2 border-l-4 border-blue-500 pl-4">
            1. データ連携フロー
        </h2>
    ...
    <div class="mb-16 animate-fade-in-up" style="animation-delay: 0.2s;">
        <h2 class="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2 border-l-4 border-green-500 pl-4">
            2. CO2吸収量 算出ロジック
        </h2>
    ...
    <div class="mb-16 animate-fade-in-up" style="animation-delay: 0.3s;">
        <h2 class="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2 border-l-4 border-purple-500 pl-4">
            3. 実務負荷の軽減
        </h2>
    ...
    <div class="mb-16 animate-fade-in-up" style="animation-delay: 0.4s;">
        <h2 class="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2 border-l-4 border-yellow-500 pl-4">
            4. 導入・算出開始までのステップ
        </h2>
        ...
        <div class="glass-panel-premium p-8 rounded-2xl">
            <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="flex-1 relative group">
                    ...
                    <div class="bg-gray-100 p-6 rounded-xl border border-gray-200 h-full hover:border-yellow-500/50 transition">
                        <div class="text-yellow-500 mb-2"><i data-lucide="map" class="w-8 h-8"></i></div>
                        <h4 class="font-bold text-gray-900 mb-2">エリア登録</h4>
                ...
                <div class="flex-1 relative group">
                    ...
                    <div class="bg-gray-100 p-6 rounded-xl border border-gray-200 h-full hover:border-yellow-500/50 transition">
                        ...
                        <h4 class="font-bold text-gray-900 mb-2">データ収集</h4>
                        <p class="text-xs text-gray-500 leading-relaxed">
                ...
                <div class="flex-1 relative group">
                    ...
                    <div class="bg-gradient-to-br from-gray-800 to-green-900/20 p-6 rounded-xl border border-green-500/30 h-full hover:border-green-500 transition shadow-[0_0_20px_rgba(34,197,94,0.1)]">
                        ...
                        <h4 class="font-bold text-gray-900 mb-2">自動解析 &amp; レポート</h4>
                        <p class="text-xs text-gray-500 leading-relaxed">
    ...
    <div class="mb-16 animate-fade-in-up" style="animation-delay: 0.6s;">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <!-- Standard -->
            <div class="bg-gray-50 p-8 rounded-2xl border border-gray-200 flex flex-col relative overflow-hidden">
                <div class="absolute top-0 right-0 p-4 opacity-10"><i data-lucide="leaf" class="w-16 h-16 text-white"></i></div>
                <h3 class="text-lg font-bold text-gray-900 mb-2">スタンダード (Standard)</h3>
                <div class="text-3xl font-black text-gray-900 mb-1">付属<span class="text-sm font-normal text-gray-500 ml-1">/ 年</span></div>
                ...
                <button class="w-full py-3 rounded-xl border border-gray-300 text-gray-400 text-sm font-bold cursor-not-allowed bg-gray-100">標準付帯</button>
            </div>
