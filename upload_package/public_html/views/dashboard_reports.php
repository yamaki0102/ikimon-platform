    ...
    <div class="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-6">
        ...
        <div class="space-y-6 max-w-2xl">
            <div>
                ...
                <select class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2 text-gray-900 focus:border-green-500 outline-none">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label class="text-sm text-gray-500 block mb-2">期間選択</label>
                    <select class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2 text-gray-900">
                        <option>直近30日</option>
                        <option>直近90日</option>
                        <option>今年度</option>
                ...
                <div>
                    <label class="text-sm text-gray-500 block mb-2">フォーマット</label>
                    <select id="report-format" class="w-full bg-gray-50 border border-gray-200 rounded-lg px-4 py-2 text-gray-900" onchange="toggleReportDescription()">
            ...
            <div id="credit-report-desc" class="hidden bg-green-50 border border-green-200 rounded-lg p-4 text-sm text-gray-600">
                ...
                <ul class="list-disc list-inside text-xs text-gray-500 pl-2 space-y-1">
                    <li>種多様性インデックスの推移</li>
        ...
        <div class="space-y-3">
            <div class="flex items-center justify-between p-4 bg-gray-100 rounded-lg">
                <div>
                    ...
                    <div class="text-sm text-gray-500">環境省認定様式 • 2024/11/15</div>
                </div>
                <button class="px-4 py-2 bg-gray-200 hover:bg-gray-300 rounded-lg text-sm font-bold transition">再ダウンロード</button>
            </div>
        </div>
    </div>
</div>
