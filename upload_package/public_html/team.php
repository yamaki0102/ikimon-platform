    ...
    <section class="pt-32 pb-16 px-6">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-16">
                ...
                <div class="glass-card p-8 rounded-2xl border border-gray-200">
            ...
            <div class="mb-16">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <!-- Advisor 1 -->
                    <div class="glass-card p-6 rounded-2xl border border-gray-200">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="font-bold text-gray-900">【募集中】</h3>
            ...
            <!-- Join CTA -->
            <div class="p-8 rounded-2xl border-2 border-dashed border-gray-300 text-center">
