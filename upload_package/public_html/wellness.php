...
<body class="js-loading bg-base text-text font-body">
    ...
    <main class="max-w-4xl mx-auto px-4 md:px-6 py-12 md:py-32 pb-32" x-data="wellnessDashboard()" x-init="loadData()">
        ...
        <header class="mb-12">
            <div class="flex items-center gap-4 mb-3">
                ...
                <div>
                    <h1 class="text-2xl md:text-3xl font-black text-text tracking-tight flex items-center gap-3">
                        🌿 ネイチャーウェルネス
                    </h1>
