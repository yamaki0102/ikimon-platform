...
<body class="js-loading pt-14 font-body" style="background:var(--md-surface);color:var(--md-on-surface);">
    ...
    <main class="max-w-5xl mx-auto px-4 md:px-6 py-12 md:py-32 pb-32" x-data="wellnessDashboard()" x-init="loadData()">
        ...
        <div x-show="!loading" x-cloak>
            ...
            <section style="background:var(--md-surface-container);border:1px solid var(--md-outline-variant);border-radius:var(--shape-xl);padding:1.5rem;margin-bottom:1.5rem;box-shadow:var(--elev-1);">
                ...
                <div class="space-y-4">
                    <template x-for="(week, i) in (data?.weekly_nature ?? [])" :key="i">
                        <div>
                            ...
                            <div class="relative h-3 rounded-full overflow-hidden" style="background:var(--md-surface-container-low);">
            ...
            <section style="background:var(--md-surface-container);border:1px solid var(--md-outline-variant);border-radius:var(--shape-xl);padding:1.5rem;margin-bottom:1.5rem;box-shadow:var(--elev-1);">
                ...
                <div class="space-y-3">
                    <template x-for="(s, i) in sessions" :key="i">
                        <div class="flex items-center gap-4 p-3 rounded-xl bg-base hover:bg-base/80 transition">
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-6">
                <!-- Cognitive -->
                <section style="background:var(--md-surface-container);border:1px solid var(--md-outline-variant);border-radius:var(--shape-xl);padding:1.5rem;box-shadow:var(--elev-1);">
                    <h2 class="text-sm font-black text-text uppercase tracking-widest mb-5 flex items-center gap-2">
                        <span>🧠</span> 認知ウェルネス
                    </h2>
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="relative h-2 rounded-full overflow-hidden" style="background:var(--md-surface-container-low);">
                ...
                <section style="background:var(--md-surface-container);border:1px solid var(--md-outline-variant);border-radius:var(--shape-xl);padding:1.5rem;box-shadow:var(--elev-1);">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-center justify-between p-3 rounded-xl bg-base">
            ...
            <section style="background:var(--md-surface-container);border:1px solid var(--md-outline-variant);border-radius:var(--shape-xl);padding:1.5rem;box-shadow:var(--elev-1);">
                ...
                <div class="space-y-4 text-sm text-muted leading-relaxed">
                    <div class="p-4 rounded-xl bg-base border-l-4 border-primary">
                    ...
                    <div class="p-4 rounded-xl bg-base border-l-4 border-secondary">
                    ...
                    <div class="p-4 rounded-xl bg-base border-l-4 border-accent">
                    ...
                    <div class="p-4 rounded-xl bg-base border-l-4 border-muted mt-4">
