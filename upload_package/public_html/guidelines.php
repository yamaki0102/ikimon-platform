...
<body class="bg-[var(--color-bg-base)] text-[var(--color-text)] font-body">
    ...
    <main class="max-w-4xl mx-auto px-6 py-20 pb-32">
        <header class="mb-20 text-center">
            <span class="inline-block px-4 py-1 rounded-full bg-surface border border-border text-[var(--color-primary)] text-xs font-bold uppercase tracking-widest mb-6">Values & Rules</span>
        ...
        <section class="space-y-24">
            <!-- 1. Authenticity -->
            <div class="glass-card p-10 rounded-3xl border-border relative overflow-hidden">
                ...
                <div class="relative z-10 flex gap-8 flex-col md:flex-row">
                    ...
                    <div>
                        ...
                        <ul class="space-y-4 text-muted leading-relaxed list-disc list-inside marker:text-green-500">
            ...
            <div class="glass-card p-10 rounded-3xl border-border relative overflow-hidden">
                ...
                <div class="relative z-10 flex gap-8 flex-col md:flex-row">
                    ...
                    <div>
                        ...
                        <ul class="space-y-4 text-muted leading-relaxed list-disc list-inside marker:text-blue-500">
            ...
            <div class="glass-card p-10 rounded-3xl border-border relative overflow-hidden">
                ...
                <div class="relative z-10 flex gap-8 flex-col md:flex-row">
                    ...
                    <div>
                        ...
                        <ul class="space-y-4 text-muted leading-relaxed list-disc list-inside marker:text-yellow-500">
        ...
        <div class="mt-20 space-y-12">
            ...
            <div class="glass-card p-10 rounded-3xl border-border relative overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <div class="grid md:grid-cols-2 gap-6">
                        <div class="space-y-3 text-muted text-sm">
            ...
            <!-- ライセンス -->
            <div class="glass-card p-8 rounded-3xl border-border text-center">
                <p class="text-sm text-muted mb-2">投稿データには、投稿時に選択した <strong class="text-text">CC0 / CC BY / CC BY-NC</strong> ライセンスが適用されます</p>
                <p class="text-xs text-faint">30by30や環境保全調査に活用 — 写真の著作権は投稿者に帰属</p>
            </div>
        </div>

        <div class="mt-12 text-center">
            <p class="text-muted mb-8">このガイドラインに違反するコンテンツを見つけた場合は、通報機能を使用してください。</p>
