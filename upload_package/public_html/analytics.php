...
<body class="js-loading pt-14 pb-20 bg-base text-text font-body">
    ...
    <main class="max-w-4xl mx-auto px-4 py-8 space-y-6">
        ...
        <section class="bg-surface rounded-xl p-4 shadow-sm border border-border">
