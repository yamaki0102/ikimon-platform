...
<div x-data="{ open: false }"
    ...
    <div x-show="open"
        ...
        <div class="px-4 space-y-2 mb-4">
            ...
            <a href="/bioscan.php" class="flex items-center gap-4 p-4 rounded-xl bg-surface hover:bg-surface-hover transition border border-border" style="text-decoration:none">
