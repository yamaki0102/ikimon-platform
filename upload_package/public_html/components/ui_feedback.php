        ...
        <template x-for="toast in $store.toast.items" :key="toast.id">
            <div x-show="toast.visible"
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-gray-400" x-text="toast.message" x-show="toast.message"></p>
                </div>
                <button @click="$store.toast.dismiss(toast.id)" class="shrink-0 text-gray-400 hover:text-white transition">
