...
<div x-data="cookieConsent" x-show="showBanner" x-cloak
    ...
    <div class="max-w-4xl mx-auto glass-card rounded-2xl border border-white/10 p-6 shadow-2xl">
        <div class="flex flex-col md:flex-row items-start md:items-center gap-4">
            ...
            <div class="flex gap-2 shrink-0 w-full md:w-auto">
                ...
                <button @click="acceptEssential()" 
                        class="flex-1 md:flex-none px-6 py-2.5 rounded-xl bg-white/10 text-white font-bold text-sm hover:bg-white/20 transition">
                    必須のみ
                </button>
            </div>
