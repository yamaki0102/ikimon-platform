            ...
            <section id="century-archive" class="scroll-target">
                ...
                <div class="bg-surface rounded-2xl p-6 border border-border mb-6">
                    <div class="text-sm text-muted leading-relaxed space-y-4">
                        ...
                        <p>
                            <strong class="text-[var(--color-text)]">今年記録しなかったら、来年「去年と比べてどう変わった？」を知ることはできません。</strong>
                            10年後も、100年後も同じです。
                        </p>
                        <p>
                        ...
                        <p>
                            <strong class="text-[var(--color-text)]">今日の散歩を少しだけ楽しくする。</strong>
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-emerald-950/30 dark:to-teal-950/30 rounded-2xl p-6 border border-emerald-200 dark:border-emerald-800">
                    <h3 class="text-sm font-bold text-center mb-4">アーカイブは、もう始まっています</h3>
                    <div class="flex justify-around text-center">
                        <div>
                            <div class="text-2xl font-black text-emerald-500"><?= number_format($totalObs) ?></div>
                            <div class="text-xs text-muted">観察記録</div>
                        </div>
                        <div>
            ...
            <section id="data-gap" class="scroll-target">
                ...
                <div class="bg-surface rounded-2xl p-6 border border-border space-y-4">
                    ...
                    <div class="bg-rose-50 dark:bg-rose-950/20 rounded-xl p-4 border border-rose-200 dark:border-rose-800/40">
                        <p class="text-sm font-bold text-[var(--color-text)] leading-relaxed">
                            「データがたくさんある」ことと「自然を守るために何をすべきかわかる」ことは、まったく別の話だ。
                        </p>
                    </div>
                    <p class="text-sm text-muted leading-relaxed">
                        バラバラの形式で散らばった記録、品質が不明なデータ、行政や企業の判断材料として使えない情報 ——
                        いくら量が増えても、<strong class="text-[var(--color-text)]">「何が起きているか」はわかっても「何をすべきか」にはたどり着けない</strong>。
                        それが現状の課題です。
                    </p>
                </div>
            </section>
            ...
            <section id="evidence" class="scroll-target">
                ...
                <div class="bg-surface rounded-2xl p-6 border border-border space-y-4">
                    <p class="text-sm text-muted leading-relaxed">
                        ...
                        <strong class="text-[var(--color-text)]">44名の研究者による共同提言</strong>に基づいています。
                    </p>
                    <p class="text-sm text-muted leading-relaxed">
                    ...
                    <details class="group">
                        ...
                        <div class="mt-4 space-y-3 text-xs text-muted">
                            <div class="flex items-start gap-2">
                                ...
                                <span><strong class="text-[var(--color-text)]">データ統合</strong> — 写真・音声・GPS・環境データを1つの構造で記録</span>
                            </div>
                            <div class="flex items-start gap-2">
                                ...
                                <span><strong class="text-[var(--color-text)]">標準化</strong> — DarwinCore 準拠の世界共通形式</span>
                            </div>
                            <div class="flex items-start gap-2">
                                ...
                                <span><strong class="text-[var(--color-text)]">較正</strong> — AI + コミュニティ + 専門家の段階的検証</span>
                            </div>
                            <div class="flex items-start gap-2">
                                ...
                                <span><strong class="text-[var(--color-text)]">信頼できるDB</strong> — 検証ログと監査証跡の保持</span>
                            </div>
                            <div class="flex items-start gap-2">
                                ...
                                <span><strong class="text-[var(--color-text)]">耐性</strong> — GBIF 連携によるプラットフォーム非依存の永続性</span>
                            </div>
                            <div class="flex items-start gap-2 opacity-60">
                                ...
                                <span><strong class="text-[var(--color-text)]">地域知識の統合</strong> — 地域住民の知見を活かす仕組み（今後の課題）</span>
                            </div>
                            <div class="flex items-start gap-2 opacity-60">
                                ...
                                <span><strong class="text-[var(--color-text)]">介入効果の定量化</strong> — 保全活動の効果測定（今後の課題）</span>
                            </div>
                        </div>
                    </details>
