            ...
            <div class="space-y-8">
                ...
                <article x-show="filter === 'all' || filter === 'feature'" x-transition class="relative pl-8 border-l-2 border-emerald-500/30">
                    ...
                    <div class="flex items-center gap-3 flex-wrap mb-3">
                        <span class="px-3 py-1 rounded-full text-xs font-bold bg-emerald-100 text-emerald-700 border border-emerald-200">BioScan v0.4.0</span>
                        <time class="text-sm text-gray-500">2026年3月26日</time>
                    ...
                    <h2 class="text-xl font-bold mb-3 text-gray-900">BioScan v0.4.0 — 反復航路観測OS へ進化</h2>
                    <p class="text-gray-500 text-sm mb-4">BioScan を単発の AI 認識アプリから「反復航路観測 OS」へ方向転換。通勤・散歩・定点を別の観測目的として扱い、毎日の移動が 100 年アーカイブに貢献する設計に。</p>
                    <ul class="space-y-2 text-gray-600 text-sm">
                        <li class="flex items-start gap-2"><span class="text-emerald-400 shrink-0">✓</span><span><strong>観測モード導入</strong>: 散歩 / 通勤 / 定点観測 / フィールド調査の 4 モード。目的に応じたスキャン戦略に自動切替</span></li>
                        <li class="flex items-start gap-2"><span class="text-emerald-400 shrink-0">✓</span><span><strong>移動モード手動選択</strong>: 徒歩 / 自転車 / 車 / 定点を人間が選択。車モードでは視覚スキャンを自動停止し、音声・センサーに集中</span></li>
                        <li class="flex items-start gap-2"><span class="text-emerald-400 shrink-0">✓</span><span><strong>セッションサマリー画面</strong>: 終了後に種リスト・移動距離・時間・環境統計（平均気温・気圧・照度）を一覧表示</span></li>
                        <li class="flex items-start gap-2"><span class="text-emerald-400 shrink-0">✓</span><span><strong>環境ステータスバー</strong>: スキャン中に温度・気圧・照度・コンパスをリアルタイム表示</span></li>
                        <li class="flex items-start gap-2"><span class="text-emerald-400 shrink-0">✓</span><span><strong>セッションタイマー & 移動状態</strong>: 経過時間と静止/歩行/走行/車の状態を TopBar に常時表示</span></li>
                        <li class="flex items-start gap-2"><span class="text-emerald-400 shrink-0">✓</span><span><strong>検出ミニタイムライン</strong>: 種レーダーをタップすると検出履歴がスライドイン表示</span></li>
                        <li class="flex items-start gap-2"><span class="text-emerald-400 shrink-0">✓</span><span><strong>音響複雑度指数（ACI）</strong>: 3 秒チャンクから ACI を自動計算し環境スナップショットに統合。生物音の豊かさを数値化</span></li>
                        <li class="flex items-start gap-2"><span class="text-emerald-400 shrink-0">✓</span><span><strong>多言語化基盤</strong>: 日本語・英語・スペイン語・ポルトガル語のリソース準備完了</span></li>
                        <li class="flex items-start gap-2"><span class="text-blue-400 shrink-0">⟳</span><span><strong>セッション管理修正</strong>: UI 反映の整合性向上・前回セッションのデータ汚染を防止</span></li>
                        <li class="flex items-start gap-2"><span class="text-blue-400 shrink-0">⟳</span><span><strong>バージョン管理刷新</strong>: 1.0 = Google Play リリースと定義。0.x は開発版。同期ペイロードにビルドバージョンを自動送信</span></li>
                    </ul>
                </article>
