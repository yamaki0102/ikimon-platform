...
<main class="max-w-3xl mx-auto px-4 sm:px-6 pt-24 pb-24" x-data="observationEditor()">
    ...
    <section class="rounded-3xl border border-border bg-surface shadow-sm p-6 sm:p-8">
        ...
        <div class="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
            <?php foreach (array_slice($obs['photos'] ?? [], 0, 3) as $photo): ?>
                <img src="<?= htmlspecialchars($photo) ?>" alt="観察写真" class="aspect-square rounded-2xl object-cover border border-border bg-base">
            <?php endforeach; ?>
        </div>
        ...
        <form class="mt-8 space-y-6" @submit.prevent="submit">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <label class="block">
                    ...
                    <input x-model="form.observed_at" type="datetime-local" class="w-full rounded-2xl border border-border bg-base px-4 py-3 text-sm text-text focus:outline-none focus:border-primary">
                </label>
                <label class="block">
                    <span class="block text-[10px] font-black uppercase tracking-[0.18em] text-faint mb-2">ライフステージ</span>
                    <select x-model="form.life_stage" class="w-full rounded-2xl border border-border bg-base px-4 py-3 text-sm text-text focus:outline-none focus:border-primary">
                ...
                <label class="block">
                    <span class="block text-[10px] font-black uppercase tracking-[0.18em] text-faint mb-2">緯度</span>
                    <input x-model="form.lat" type="number" step="0.0000001" class="w-full rounded-2xl border border-border bg-base px-4 py-3 text-sm text-text focus:outline-none focus:border-primary">
                </label>
                <label class="block">
                    <span class="block text-[10px] font-black uppercase tracking-[0.18em] text-faint mb-2">経度</span>
                    <input x-model="form.lng" type="number" step="0.0000001" class="w-full rounded-2xl border border-border bg-base px-4 py-3 text-sm text-text focus:outline-none focus:border-primary">
                </label>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <label class="block">
                    ...
                    <select x-model="form.biome" class="w-full rounded-2xl border border-border bg-base px-4 py-3 text-sm text-text focus:outline-none focus:border-primary">
                ...
                <label class="block">
                    ...
                    <select x-model="form.individual_count" class="w-full rounded-2xl border border-border bg-base px-4 py-3 text-sm text-text focus:outline-none focus:border-primary">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <label class="block">
                    ...
                    <select x-model="form.cultivation" class="w-full rounded-2xl border border-border bg-base px-4 py-3 text-sm text-text focus:outline-none focus:border-primary">
                ...
                <label class="block">
                    ...
                    <select x-model="form.organism_origin" class="w-full rounded-2xl border border-border bg-base px-4 py-3 text-sm text-text focus:outline-none focus:border-primary">
                        <option value="wild">野生</option>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <label class="block">
                    ...
                    <select x-model="form.managed_context_type" class="w-full rounded-2xl border border-border bg-base px-4 py-3 text-sm text-text focus:outline-none focus:border-primary">
                ...
                <label class="block">
                    ...
                    <input x-model="form.managed_site_name" type="text" class="w-full rounded-2xl border border-border bg-base px-4 py-3 text-sm text-text focus:outline-none focus:border-primary">
                </label>
            </div>
            ...
            <div class="flex flex-wrap items-center gap-3">
                ...
                <a href="/observation_detail.php?id=<?= urlencode($id) ?>" class="inline-flex min-h-[48px] items-center justify-center rounded-full border border-border bg-white px-6 text-sm font-bold text-text">戻る</a>
