...
class CspNonce
{
    ...
    public static function sendHeader(): void
    {
        ...
        $csp = implode('; ', [
            ...
            "img-src 'self' data: blob: https://i.pravatar.cc https://*.tile.openstreetmap.jp https://*.tile.openstreetmap.org https://*.basemaps.cartocdn.com https://basemaps.cartocdn.com https://tile.openstreetmap.jp https://cyberjapandata.gsi.go.jp https://lh3.googleusercontent.com https://inaturalist-open-data.s3.amazonaws.com https://static.inaturalist.org",
            "connect-src 'self' https://api.gbif.org https://api.inaturalist.org https://tile.openstreetmap.jp https://*.tile.openstreetmap.jp https://basemaps.cartocdn.com https://*.basemaps.cartocdn.com https://cdn.jsdelivr.net https://fonts.googleapis.com https://fonts.gstatic.com https://nominatim.openstreetmap.org https://unpkg.com https://www.google-analytics.com https://www.googletagmanager.com https://api.open-meteo.com https://overpass-api.de",
