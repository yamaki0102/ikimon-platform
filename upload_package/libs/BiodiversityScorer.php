...
class BiodiversityScorer
{
        ...
        return [
            ...
            'breakdown' => [
                'richness' => [
                    ...
                    'raw_label' => "H'=" . round($shannonIndex, 2) . " ({$speciesCount}種)",
                ...
                'data_confidence' => [
                    ...
                    'raw_label' => "RG率" . round($rgRatio * 100) . "% ({$rgCount}/{$obsCount})",
                    'score'    => round($dcScore),
                ...
                'conservation_value' => [
                    ...
                    'raw_label' => "RL掲載" . count($redListMatches) . "種",
                    'score'    => round($cvScore),
                ...
                'taxonomic_coverage' => [
                    ...
                    'raw'      => $detectedGroups,
                    'raw_label' => "{$detectedGroups}/{$expectedGroups}分類群",
                    'score'    => round($tcScore),
                ...
                'monitoring_effort' => [
                    'label'    => 'Monitoring Effort',
                    'raw'      => $monthsCovered,
                    'raw_label' => "{$monthsCovered}ヶ月 / {$activeYears}年",
                    'score'    => round($meScore),
    ...
    private static function emptyResult(): array
    {
        return [
            ...
            'shannon_index'  => 0.0,
            'breakdown' => [
                'richness'           => ['label' => 'Species Richness',    'raw' => 0, 'raw_label' => "H'=0 (0種)",       'score' => 0, 'weighted' => 0, 'weight' => 0.30],
                'data_confidence'    => ['label' => 'Data Confidence',     'raw' => 0, 'raw_label' => 'RG率0% (0/0)',      'score' => 0, 'weighted' => 0, 'weight' => 0.20],
                'conservation_value' => ['label' => 'Conservation Value',  'raw' => 0, 'raw_label' => 'RL掲載0種',         'score' => 0, 'weighted' => 0, 'weight' => 0.25, 'matches' => []],
                'taxonomic_coverage' => ['label' => 'Taxonomic Coverage',  'raw' => 0, 'raw_label' => '0/8分類群',          'score' => 0, 'weighted' => 0, 'weight' => 0.15, 'groups' => []],
                'monitoring_effort'  => ['label' => 'Monitoring Effort',   'raw' => 0, 'raw_label' => '0ヶ月 / 0年',       'score' => 0, 'weighted' => 0, 'weight' => 0.10],
            ],
            'top_species' => [],
