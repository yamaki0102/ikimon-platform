...
class AsyncJobMetrics
{
    ...
    public static function recordPostRequest(array $payload): void
    {
        self::append(self::POST_FILE, [
            ...
            'canonical_write_success' => !empty($payload['canonical_write_success']),
            'canonical_write_skipped' => !empty($payload['canonical_write_skipped']),
            'canonical_write_error' => (string)($payload['canonical_write_error'] ?? ''),
